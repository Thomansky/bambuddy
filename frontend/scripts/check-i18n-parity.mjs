...
const PT_BR_COGNATES = [
  ...
  'Manual',  // #3127 calibration trigger mode — same word in Portuguese
...
const ES_COGNATES = [
  ...
  'Manual',  // #3127 calibration trigger mode — same word in Spanish
...
const NL_COGNATES = [
  ...
  'Trigger',  // #3127 calibration trigger label — Dutch uses the loanword
