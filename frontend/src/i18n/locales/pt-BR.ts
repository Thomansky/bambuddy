export default {
  ...
  printers: {
    ...
    modal: {
      ...
      expectedLifetimeHours: 'Vida útil esperada (horas)',
      depreciationHelp: 'Cobra o desgaste da impressora por hora de impressão nas impressões futuras. Deixe ambos vazios para desativar.',
      depreciationRate: '≈ {{rate}} {{currency}}/h de desgaste da impressora',
