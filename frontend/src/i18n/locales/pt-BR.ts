export default {
  ...
  printers: {
    ...
    modal: {
      ...
      wearCostPerHour: 'Custo de desgaste por hora de impressão',
      wearCostPerHourHelp: 'Inclua o que uma hora de impressão realmente custa para você: depreciação, manutenção, peças. Deixe vazio para desativar.',
    ...
    drying: {
      ...
      waitingPaCalibration: 'Aguardando o término de uma calibração de dinâmica de fluxo',
  ...
  archives: {
    ...
    filterUnconfirmed: 'Não confirmadas',
    filterUnconfirmedTitle: 'Mostrar apenas impressões que ainda aguardam o veredito de resultado',
    ...
    card: {
      ...
      confirmPendingTitle: 'Esta impressão pediu um veredito de resultado — clique para responder',
      rejected: 'rejeitado',
      rejectedTitle: 'Concluída na impressora, marcada como rejeitada pelo usuário',
      confirmedGood: 'boa',
      confirmedGoodTitle: 'Confirmada como uma peça boa pelo usuário',
      duplicate: 'duplicado',
      ...
      printerWear: 'Desgaste da impressora',
    ...
    log: {
      ...
      depreciationCost: 'Desgaste da impressora',
      completedAt: 'Concluído',
      jobNumber: 'N.º trabalho',
      columns: 'Colunas',
  ...
  queue: {
    ...
    maintenanceHold: {
      run: 'Manutenção pendente: {{item}} ({{state}})',
      schedule: 'Manutenção agendada {{when}} — este trabalho avançaria sobre ela (estimado {{duration}})',
      scheduleUnknown: 'Manutenção agendada {{when}} — este trabalho avançaria sobre ela (duração desconhecida)',
      state: {
        queued: 'na fila',
        running: 'em andamento',
        printerOffline: 'impressora offline',
        printerBusy: 'impressora ocupada',
        plateClear: 'mesa ainda não liberada',
    ...
    badges: {
      ...
      confirmOutcomeTitle: 'Pergunta como a impressão ficou depois de concluída',
    },
    // Empty state
    empty: {
    ...
    bulkEdit: {
      ...
      timelapse: 'Timelapse',
      useAms: 'Usar AMS',
      confirmOutcome: 'Perguntar o resultado',
  ...
  stats: {
    ...
    rejectedPrintsCount: '{{rejected}} rejeitadas após a conclusão',
    yieldRate: 'Rendimento: {{rate}}%',
  ...
  maintenance: {
    ...
    section: {
      automatic: 'Executa sozinha',
      automaticHint: 'O Bambuddy as inicia na impressora quando vencem e ela está livre — você só é avisado.',
      manual: 'Você faz',
      manualHint: 'Um lembrete. O Bambuddy acompanha o vencimento; o trabalho e a baixa são seus.',
    },
    noItems: 'Nenhuma manutenção configurada ainda',
    switchedOffCount: '{{count}} desativados',
    allItemsSwitchedOff: 'Todos os itens desta impressora estão desativados',
    ...
    calibration: {
      option: {
        bed_leveling: 'Nivelamento da mesa',
        vibration: 'Compensação de vibração',
        motor_noise: 'Cancelamento de ruído do motor',
        nozzle_offset: 'Offset do bico',
        high_temp_heatbed: 'Nivelamento da mesa em alta temperatura',
      ...
      reserveBeforeSchedule: 'Não iniciar trabalhos que avançariam sobre o horário agendado',
      runNow: 'Executar agora',
      cancelRun: 'Cancelar execução',
      runQueued: 'Na fila – começa assim que a impressora estiver livre',
      runningSince: 'Calibração em andamento desde {{time}}',
      nextRunAt: 'Próxima execução: {{time}}',
      ...
      waitingAfterOtherRun: 'Aguardando: após {{item}}',
      ...
      lastRunCancelled: 'Última execução cancelada {{time}}',
      runQueuedToast: 'Calibração enfileirada',
      runCancelledToast: 'Execução da calibração cancelada',
      runsCalibration: 'Executa uma calibração',
    },
  },
  ...
  settings: {
    ...
    autoLinkScannedSpools: 'Vincular automaticamente carretéis escaneados',
    autoLinkScannedSpoolsDesc: 'Quando um carretel escaneado ou adicionado automaticamente corresponder a um produto existente, vincula-o a esse carretel para que ele chegue com os dados completos do filamento — incluindo o preço por kg.',
    ...
    rfidAfterPrintDescription: 'A mesma leitura na outra ponta: quando uma impressão termina a impressora está livre, o AMS pode movimentar filamento e nenhum trabalho espera pela resposta. Roda depois de cada impressão, concluída ou com falha. O AMS só consegue ler com nada carregado — as impressoras normalmente retraem o filamento ao terminar —, então uma que ainda tenha um carretel no bico fica para depois da próxima impressão. Para na hora se uma nova impressão começar e o desligamento automático espera a leitura terminar.',
    rfidAfterPrintUnloadLabel: 'Descarregar antes de ler',
    rfidAfterPrintUnloadDescription: 'Uma impressora que ainda tem filamento carregado quando a impressão termina não consegue ler nenhuma etiqueta: o AMS precisa movimentar filamento para alcançá-la. Com esta opção ligada, o filamento é primeiro retraído para o AMS e só então a leitura acontece. A impressora fica descarregada depois; a próxima impressão carrega o que precisar. Uma impressora que já retraiu o filamento, o caso habitual, nunca recebe um comando de descarga.',
    ...
    suppliers: {
      title: 'Fornecedores',
      description: 'Gerencie onde você compra filamento — diferente da marca, que é quem o fabricou. Atribua fornecedores aos carretéis no diálogo do carretel; um fornecedor que ainda está atribuído a carretéis não pode ser excluído.',
      search: 'Pesquisar fornecedores...',
      addNew: 'Adicionar novo fornecedor',
      namePlaceholder: 'Nome (ex. Filament24)',
      websitePlaceholder: 'Site / URL da loja',
      customerNumberPlaceholder: 'Nº de cliente',
      notePlaceholder: 'Observação',
      nameRequired: 'O nome é obrigatório',
      customerNumber: 'Nº de cliente',
      spools: 'Carretéis',
      noMatch: 'Nenhum fornecedor corresponde à sua pesquisa',
      empty: 'Nenhum fornecedor ainda',
      ...
      deleteFailed: 'Falha ao excluir fornecedor',
      deleteBlocked: 'Não é possível excluir: ainda atribuído a {{count}} carretel(éis)',
      loadFailed: 'Falha ao carregar fornecedores',
      deleteTitle: 'Excluir Fornecedor',
      deleteConfirm: 'Excluir "{{name}}"?',
      deleteConfirmReferenced: '"{{name}}" está atribuído a {{count}} carretel(éis). A exclusão fica bloqueada até que essas atribuições sejam removidas.',
    },
    catalog: {
    ...
    libraryRootView: 'O que a raiz mostra',
    libraryRootViewAll: 'Todos os arquivos',
    libraryRootViewAllDescription: 'Todos os arquivos da biblioteca em uma única lista plana.',
    libraryRootViewFolders: 'Apenas pastas',
    libraryRootViewFoldersDescription: 'As pastas de primeiro nível e uma entrada «Sem pasta» para os arquivos fora de qualquer pasta.',
    libraryRootViewRecent: 'Adicionados ou alterados recentemente',
    libraryRootViewRecentDescription: 'Os arquivos mais recentes de toda a biblioteca, até 100 - uma página inicial, não uma listagem.',
    libraryRootViewDescription: 'A busca e os filtros por etiqueta sempre percorrem a biblioteca inteira, qualquer que seja a escolha.',
    webdavMode: 'Acesso WebDAV',
    ...
    webdavModeOff: 'Desligado',
    webdavModeOffDescription: 'O endereço responde 404, igual a uma instalação que nunca teve o recurso.',
    webdavModeRead: 'Somente leitura',
    webdavModeReadDescription: 'Os arquivos podem ser abertos e copiados; nada feito na unidade mapeada altera a biblioteca.',
    webdavModeReadWrite: 'Leitura e gravação',
    webdavModeReadWriteDescription: 'Também salvar, renomear, mover e excluir pela unidade, com as mesmas permissões de biblioteca que a interface web aplica.',
    ...
    webdavHttpsHint: 'Publique por HTTPS, porque as credenciais Basic vão em cada uma das requisições.',
    ...
    webdavWriteHint: 'Gravar sobre um arquivo mantém a mesma entrada da biblioteca, com suas etiquetas e anotações, e substitui apenas o conteúdo — sem versão e sem variante. Excluir manda o arquivo para a lixeira, e uma pasta criada pela unidade não recebe número.',
    libraryStorageMode: 'Armazenamento da biblioteca',
    libraryStorageDescription: 'Onde o gerenciador de arquivos guarda seus arquivos: no armazenamento próprio do Bambuddy ou em uma árvore de diretórios que ele apenas indexa.',
    libraryStorageModeManaged: 'Biblioteca própria do Bambuddy',
    libraryStorageModeManagedDescription: 'Os arquivos ficam no diretório de dados do Bambuddy e só são alcançados por ele. Nada de fora pode movê-los, então o banco de dados e o disco sempre concordam.',
    libraryStorageModeDirectory: 'Diretório',
    libraryStorageModeDirectoryDescription: 'Um diretório escolhido por você — normalmente um compartilhamento de rede — passa a ser a própria biblioteca: cada pasta é um diretório real, cada arquivo mantém o nome real e a mesma árvore abre no Explorador.',
    libraryStoragePath: 'Caminho do diretório',
    libraryStoragePathHint: 'Caminho absoluto como o servidor do Bambuddy o vê, ou seja, um compartilhamento precisa estar montado lá primeiro. Ele deve existir, permitir gravação e ficar fora dos diretórios de dados do Bambuddy.',
    libraryStorageDriftHint: 'Tudo que for movido ou apagado diretamente no diretório fica invisível para o Bambuddy até a pasta ser verificada, então verificar passa a fazer parte da rotina em vez de ser algo pontual.',
    libraryStorageHashHint: 'Arquivos encontrados por uma verificação não recebem hash — ler cada arquivo de um compartilhamento custa uma passagem completa — e por isso não participam da detecção de duplicatas. Arquivos gravados pelo Bambuddy recebem, como antes.',
    libraryStorageMigration: 'Mover a biblioteca existente para o diretório',
    libraryStorageMigrationHint: 'Trocar o modo não move nada por si só. Aqui cada arquivo é copiado para o seu lugar na árvore, a cópia é conferida e só então o original é removido. A ação pode ser repetida a qualquer momento e move o que ainda faltar.',
    libraryStoragePlanButton: 'Mostrar o que seria movido',
    libraryStorageMigrateButton: 'Mover agora',
    libraryStoragePlanSummary: '{{files}} arquivo(s), {{folders}} pasta(s), {{size}} a mover.',
    libraryStorageMigrationDone: '{{files}} arquivo(s) movido(s), {{folders}} diretório(s) criado(s).',
    libraryStorageMigrationFailed: 'Não foi possível iniciar a migração.',
    libraryStoragePathRequired: 'Informe o caminho primeiro.',
    ...
    libraryStorageScanDone: 'Verificação concluída: {{added}} adicionados, {{removed}} removidos.',
    libraryStoragePlanFirst: 'Mostre primeiro o que seria movido.',
    libraryStorageBlocked: 'A mudança está bloqueada por {{blockers}} colisão(ões) de nomes:',
    libraryStorageBlockerCollision: '{{first}} e {{second}} virariam o mesmo arquivo. Renomeie um deles.',
    libraryStorageBlockerExists: '{{name}} já existe lá. Mova ou renomeie no compartilhamento.',
    storageUsageLibraryTree: 'Os arquivos da biblioteca estão em {{path}}.',
    storageUsageLibraryTreeFree: '{{free}} livres de {{total}}',
    ...
    numberSeries: {
      ...
      padding: 'Dígitos',
      preview: 'próximo: {{value}}',
      lowerHint: 'Reduzir o próximo número pode reatribuir um número que já foi usado.',
      loadError: 'Não foi possível carregar as séries de numeração.',
      saveError: 'Não foi possível salvar a série de numeração.',
    },
    pipelineLimits: {
  ...
  fileManager: {
    ...
    renderingPreviews: 'Gerando pré-visualizações… {{done}}/{{total}}',
    generateThumbnailsForMissing: 'Gerar miniaturas para arquivos STL e PDF sem pré-visualização',
    gridView: 'Visualização em grade',
    listView: 'Visualização em lista',
    ...
    noFolder: 'Sem pasta',
    recentCrumb: 'Recentes',
    sortedByRecent: 'Ordenado pela data de adição ou alteração',
    pathBar: {
      label: 'Local',
      showHidden: 'Mostrar pastas ocultas',
      editPath: 'Editar caminho',
      noSuchFolder: 'Essa pasta não existe',
      siblings: 'Pastas deste nível',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        date: 'Data',
        attachments: 'Anexos',
        noBody: 'Esta mensagem não possui corpo de texto.',
        rtfNote: 'Texto extraído de conteúdo rich text — formatação simplificada.',
      },
    },
    details: {
    ...
    toast: {
      ...
      previewsRendered: '{{count}} pré-visualização(ões) gerada(s) no navegador',
  ...
  projects: {
    ...
    number: 'Número',
    numberPlaceholder: 'Atribuído automaticamente',
    numberTaken: 'Esse número já é usado por outro projeto.',
    description: 'Descrição',
  ...
  inventory: {
    ...
    vatInclShort: 'c/ IVA',
    vatExclShort: 's/ IVA',
    vatConvertedIncl: '= {{value}} com IVA',
    vatConvertedExcl: '= {{value}} sem IVA',
    ...
    suppliers: {
      ...
      noneLeft: 'Todos os fornecedores já estão atribuídos',
      createNew: 'Criar "{{name}}"',
      createFailed: 'Falha ao criar fornecedor',
      purchaseSource: 'Comprado aqui',
      purchaseSourceHelp: 'Indica onde este carretel foi realmente comprado; as outras entradas são fontes alternativas.',
      articleNumberPlaceholder: 'Nº do artigo no fornecedor',
      pricePlaceholder: 'Preço cotado/kg',
      priceHelp: 'Preço cotado neste fornecedor, para comparar fontes — o custo por kg do próprio carretel continua sendo a base de custo.',
      help: 'Onde este produto pode ser comprado. A entrada destacada é onde este carretel foi comprado.',
      saveFailed: 'Falha ao salvar as atribuições de fornecedor',
    },
    linked: {
      column: 'Vinculado',
      indicatorTooltip: 'Carretel vinculado — os dados do filamento são compartilhados com seu grupo',
      linkTitle: 'Vincular carretéis',
      pickSourceHint: 'Escolha o carretel cujos dados de filamento devem prevalecer. Marca, cor, pesos, temperaturas, preço e notas dele são copiados para os outros e permanecem sincronizados a partir de então. Peso restante, tags, locais e histórico continuam sempre por carretel.',
      searchPlaceholder: 'Pesquisar carretéis…',
      noCandidates: 'Nenhum carretel para escolher',
      alreadyLinked: 'vinculado',
      linkConfirm: 'Isso substituirá os dados de filamento de {{count}} carretel(éis).',
      linkAction: 'Vincular',
      linkedToast: 'Vinculado — {{count}} registro(s) atualizado(s)',
      linkFailed: 'Falha ao vincular carretéis',
      banner: 'Vinculado a {{count}} outro(s) carretel(éis) — alterações nos dados de filamento se aplicam a todos eles.',
      notLinked: 'Não vinculado a outros carretéis.',
      linkWithExisting: 'Vincular a um carretel existente…',
      unlinkAction: 'Desvincular',
      unlinkedToast: 'Carretel desvinculado',
      unlinkFailed: 'Falha ao desvincular o carretel',
      propagateTitle: 'Aplicar aos carretéis vinculados?',
      propagateConfirm: 'Esta alteração também atualiza os dados de filamento de {{count}} carretel(éis) vinculado(s). Peso restante, tags, locais e histórico permanecem intactos.',
    },
  ...
  printModal: {
    ...
    askForOutcome: 'Perguntar o resultado',
    askForOutcomeTitle: 'Perguntar como a impressão ficou depois de concluída',
  },
  ...
  confirmOutcome: {
    title: 'Como ficou sua impressão?',
    good: 'Boa',
    reject: 'Rejeitar',
    later: 'Perguntar depois',
    noPhoto: 'Nenhuma foto do resultado disponível',
    savedGood: 'Marcada como peça boa',
    savedReject: 'Marcada como rejeitada',
    saveFailed: 'Não foi possível salvar o veredito',
    rejectReason: 'Motivo da rejeição (opcional)',
    noReason: 'Sem motivo',
    saveReject: 'Salvar',
    rejectAndReprint: 'Imprimir novamente',
  ...
  editArchive: {
    ...
    status: 'Status',
    userVerdict: 'Veredito de Resultado',
    verdicts: {
      none: 'Não definido',
      good: 'Peça boa',
      reject: 'Rejeitada',
  ...
  // Virtual Printer
  paCalibration: {
    title: 'Calibração da dinâmica de fluxo',
    menuAction: 'Calibrar dinâmica de fluxo…',
    printer: 'Impressora',
    nozzle: 'Bico',
    slot: 'Compartimento',
    currentK: 'K atual',
    ...
    cost: 'Duração',
    costValue: 'cerca de {{minutes}} min, cerca de {{grams}} g',
    plateType: 'Placa de impressão na mesa',
    plateTypeHint: 'A linha é fatiada para esta placa, então ela precisa corresponder à que está de fato na mesa.',
    presetsHint: 'Fatiado com estas predefinições. Escolha o perfil de filamento certo para um carretel de terceiros.',
    plateConfirm: 'A placa está vazia e a linha impressa pode ser removida depois.',
    start: 'Iniciar calibração',
    save: 'Salvar na impressora',
    discard: 'Descartar',
    cancelPrintConfirm: 'Parar a impressão de calibração?',
    oldK: 'K armazenado',
    newK: 'K medido',
    nCoef: 'Coeficiente de fluxo',
    confidence: 'Confiança',
    willOverwrite: 'Salvar substitui o perfil K existente.',
    willCreate: 'Salvar cria um novo perfil K e o vincula a este compartimento.',
    notLoaded: 'Não carregado em nenhum compartimento',
    noPermission: 'Você não tem permissão para iniciar uma impressão nesta impressora.',
    blocked: {
      model_not_supported: 'Ainda não compatível com esta impressora.',
      printer_offline: 'A impressora está offline.',
      printer_busy: 'A impressora está imprimindo.',
      printer_reserved: 'A impressora está reservada por outro trabalho.',
      run_already_active: 'Já existe uma calibração em andamento nesta impressora.',
      slicer_not_configured: 'O serviço do fatiador não responde. Esta calibração é uma impressão fatiada e precisa dele.',
      slot_empty: 'O compartimento não contém filamento identificado.',
      nozzle_unknown: 'A impressora não informou qual bico está instalado.',
      printer_preset_unavailable: 'O fatiador não traz um perfil para esta impressora e este bico.',
    },
    status: {
      queued: 'Aguardando a impressora',
      slicing: 'Fatiando',
      uploading: 'Enviando',
      printing: 'Imprimindo',
      reading_result: 'Lendo o resultado',
      awaiting_confirmation: 'Aguardando sua decisão',
      saving: 'Salvando na impressora',
      done: 'Salvo',
      failed: 'Falhou',
      cancelled: 'Cancelada',
    },
    waiting: {
      printer_offline: 'Aguardando a impressora voltar a ficar online',
      printer_busy: 'Aguardando a impressora concluir o trabalho atual',
      printer_reserved: 'Aguardando a fila liberar a impressora',
      plate_not_cleared: 'Aguardando a confirmação de que a placa está livre',
    },
    plates: {
      cool_plate: 'Placa fria',
      eng_plate: 'Placa de engenharia',
      hot_plate: 'Placa PEI lisa',
      textured_plate: 'Placa PEI texturizada',
    },
    preset: {
      printer: 'Predefinição da impressora',
      process: 'Predefinição do processo',
      filament: 'Predefinição do filamento',
    },
  },
  virtualPrinter: {
  ...
  notifications: {
    ...
    printConfirmRequest: 'Confirmação de Resultado',
    printConfirmRequestDescription: 'Pedir um veredito de boa/rejeitada com links de um toque quando uma impressão com a opção ativada for concluída',
    ...
    paCalibration: 'Calibração',
    paCalibrationTitle: 'Calibração da dinâmica de fluxo',
    paCalibrationDescription: 'Uma medição de avanço de pressão terminou e aguarda ser salva, ou a execução acabou',
