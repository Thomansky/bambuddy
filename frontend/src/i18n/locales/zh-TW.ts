export default {
  ...
  printers: {
    ...
    modal: {
      ...
      wearCostPerHour: '每列印小時損耗成本',
      wearCostPerHourHelp: '計入一個列印小時的真實成本——折舊、維護、零件。留空即為停用。',
    ...
    drying: {
      ...
      waitingPaCalibration: '正在等待流量動態校準結束',
  ...
  archives: {
    ...
    filterUnconfirmedTitle: '僅顯示仍在等待成品判定的列印',
    ...
    card: {
      ...
      failed: '失敗',
      confirmPending: '成品結果？',
      confirmPendingTitle: '此列印需要成品判定——點選以回答',
      rejected: '不良',
      rejectedTitle: '已在印表機上完成，但被使用者標記為不良',
      confirmedGood: '良品',
      confirmedGoodTitle: '已由使用者確認為良品',
      duplicate: '重複',
      ...
      printerWear: '印表機損耗',
      printerWearDetail: '{{hours}} 小時 × {{rate}} {{currency}}/小時',
  ...
  stats: {
    ...
    rejectedPrintsCount: '{{rejected}} 次完成後被判為不良',
    yieldRate: '良率：{{rate}}%',
    ...
    recalculateCostsVatHint: '列印時記錄的線軸成本保留記錄時的計價基準；僅重新套用目錄價格和預設價格。',
    exportStats: '匯出統計',
    exportAsCsv: '匯出為 CSV',
  ...
  maintenance: {
    ...
    section: {
      automatic: '自動執行',
      automaticHint: '到期且印表機閒置時，Bambuddy 會自動在印表機上執行，你只會收到通知。',
      manual: '由你完成',
      manualHint: '一則提醒。Bambuddy 負責追蹤到期時間，動手和勾選由你完成。',
    },
    noItems: '尚未設定任何維護',
    ...
    calibration: {
      ...
      lastRunCancelled: '上次執行已取消 {{time}}',
      runQueuedToast: '校正已排隊',
      runCancelledToast: '校正執行已取消',
      runsCalibration: '執行校正',
    },
  },
  ...
  settings: {
    ...
    autoLinkScannedSpools: '自動連結掃描的料盤',
    autoLinkScannedSpoolsDesc: '當掃描或自動新增的料盤與現有產品相符時，將其連結至該料盤，使其自動帶入完整的線材資料 — 包括每公斤價格。',
    filamentChecks: '耗材檢查',
    ...
    rfidAfterPrintUnloadLabel: '讀取前先退料',
    rfidAfterPrintUnloadDescription: '列印結束時仍裝載線材的印表機無法讀取任何標籤：AMS 必須移動線材才能靠近標籤。啟用後會先把線材退回 AMS，然後再讀取。之後印表機保持退料狀態，下一次列印會裝載它需要的線材。已經退過料的印表機（通常的情況）絕不會收到退料指令。',
    staggeredStart: '錯開啟動',
    ...
    suppliers: {
      title: '供應商',
      description: '管理您購買耗材的來源——與品牌不同，品牌是製造商。可在料盤對話框中為料盤指派供應商；仍指派給料盤的供應商無法刪除。',
      search: '搜尋供應商...',
      addNew: '新增供應商',
      namePlaceholder: '名稱（例如 Filament24）',
      websitePlaceholder: '網站/商店網址',
      customerNumberPlaceholder: '客戶編號',
      notePlaceholder: '備註',
      nameRequired: '名稱為必填',
      customerNumber: '客戶編號',
      spools: '料盤',
      ...
      deleteBlocked: '無法刪除：仍指派給 {{count}} 個料盤',
      loadFailed: '載入供應商失敗',
      deleteTitle: '刪除供應商',
      deleteConfirm: '刪除「{{name}}」？',
      deleteConfirmReferenced: '「{{name}}」已指派給 {{count}} 個料盤。必須先移除這些指派才能刪除。',
    },
    catalog: {
      spoolCatalog: '耗材目錄',
    ...
    libraryRootView: '根目錄顯示的內容',
    libraryRootViewAll: '所有檔案',
    libraryRootViewAllDescription: '庫中的每個檔案，匯成一個平鋪清單。',
    libraryRootViewFolders: '僅資料夾',
    libraryRootViewFoldersDescription: '頂層資料夾，以及用於不屬於任何資料夾的檔案的「無資料夾」項目。',
    libraryRootViewRecent: '最近新增或修改的',
    libraryRootViewRecentDescription: '整個庫中最新的檔案，最多 100 個 — 這是起始頁而非清單。',
    libraryRootViewDescription: '無論選擇哪一項，搜尋與標籤篩選一律涵蓋整個庫。',
    webdavMode: 'WebDAV 存取',
    webdavDescription: '透過 WebDAV 提供檔案管理員的目錄樹，讓工作站可以將它對應成磁碟機。',
    webdavModeOff: '關閉',
    webdavModeOffDescription: '該網址回應 404，與從未啟用此功能的安裝完全相同。',
    webdavModeRead: '唯讀',
    webdavModeReadDescription: '可以開啟與複製檔案；在對應磁碟機上所做的任何操作都不會變更媒體庫。',
    webdavModeReadWrite: '讀取與寫入',
    webdavModeReadWriteDescription: '還可以從磁碟機儲存、重新命名、移動與刪除，並沿用網頁介面相同的媒體庫權限。',
    ...
    webdavHttpsHint: '請透過 HTTPS 提供，因為 Basic 憑證會隨每一個請求送出。',
    ...
    webdavWriteHint: '覆寫儲存會沿用同一筆媒體庫記錄，保留其標籤與備註，只替換內容——既不產生版本也不產生變體。刪除會把檔案移到回收桶，而從磁碟機新建的資料夾不會取得編號。',
    libraryStorageMode: '檔案庫存放位置',
    libraryStorageDescription: '檔案管理員把檔案放在哪裡：Bambuddy 自己的儲存區，或只建立索引的目錄樹。',
    libraryStorageModeManaged: 'Bambuddy 自有檔案庫',
    libraryStorageModeManagedDescription: '檔案位於 Bambuddy 資料目錄，只能透過 Bambuddy 存取。外部無法移動它們，因此資料庫與磁碟始終一致。',
    libraryStorageModeDirectory: '目錄',
    libraryStorageModeDirectoryDescription: '你指定的目錄（通常是網路共用）本身成為檔案庫：每個資料夾都是真實目錄，每個檔案保留真實名稱，同一棵樹可以在檔案總管中開啟。',
    libraryStoragePath: '目錄路徑',
    libraryStoragePathHint: 'Bambuddy 伺服器所見的絕對路徑，因此共用需要先掛載在那裡。該路徑必須存在、可寫入，並且位於 Bambuddy 自身資料目錄之外。',
    libraryStorageDriftHint: '直接在目錄裡移動或刪除的內容，在掃描該資料夾之前 Bambuddy 看不到，因此掃描會成為日常操作，而不是一次性的事。',
    libraryStorageHashHint: '掃描找到的檔案不計算雜湊——讀取共用上的每個檔案需要完整走過一次——所以它們不參與重複偵測。透過 Bambuddy 寫入的檔案仍會像以前一樣計算雜湊。',
    libraryStorageMigration: '把現有檔案庫遷入目錄',
    libraryStorageMigrationHint: '僅切換模式不會移動任何東西。這裡會把每個檔案複製到樹中的對應位置，驗證副本，然後才刪除原檔。此操作可以隨時再次執行，並接著移動剩下的部分。',
    libraryStoragePlanButton: '查看將要移動的內容',
    libraryStorageMigrateButton: '立即移動',
    libraryStoragePlanSummary: '待移動 {{files}} 個檔案、{{folders}} 個資料夾，共 {{size}}。',
    libraryStorageMigrationDone: '已移動 {{files}} 個檔案，新建 {{folders}} 個目錄。',
    ...
    libraryStorageScanDone: '掃描完成：新增 {{added}}，移除 {{removed}}。',
    ...
    libraryStorageBlockerExists: '{{name}} 在那裡已經存在。請在共用上移動或重新命名它。',
    storageUsageLibraryTree: '檔案庫的檔案位於 {{path}}。',
    storageUsageLibraryTreeFree: '{{total}} 中剩餘 {{free}}',
  ...
  fileManager: {
    ...
    renderingPreviews: '正在產生預覽…… {{done}}/{{total}}',
    generateThumbnailsForMissing: '為缺少預覽圖的 STL 和 PDF 檔案產生縮圖',
    gridView: '網格檢視',
    listView: '列表檢視',
    columnsView: '分欄檢視',
    lowDiskSpaceWarning: '磁碟空間不足警告',
    ...
    noFolder: '無資料夾',
    recentCrumb: '最近',
    sortedByRecent: '依新增或修改時間排序',
    pathBar: {
      label: '位置',
      showHidden: '顯示摺疊的資料夾',
      editPath: '編輯路徑',
      noSuchFolder: '沒有這個資料夾',
      siblings: '此層級的資料夾',
    },
    search: {
    ...
    toast: {
      ...
      previewsRendered: '已在瀏覽器中產生 {{count}} 個預覽圖',
  ...
  inventory: {
    ...
    vatInclShort: '含稅',
    vatExclShort: '未稅',
    vatConvertedIncl: '= {{value}}（含稅）',
    vatConvertedExcl: '= {{value}}（未稅）',
    ...
    suppliers: {
      ...
      noneLeft: '所有供應商皆已指派',
      createNew: '建立「{{name}}」',
      createFailed: '建立供應商失敗',
      purchaseSource: '於此購買',
      purchaseSourceHelp: '標記此料盤實際購買的來源；其他項目為替代來源。',
      articleNumberPlaceholder: '供應商商品編號',
      pricePlaceholder: '報價/公斤',
      priceHelp: '此供應商的報價，用於比較購買來源；料盤本身的每公斤成本仍為成本基準。',
      help: '此產品可購買的地點。醒目標示的項目為此料盤的實際購買處。',
      saveFailed: '儲存供應商指派失敗',
    },
    linked: {
      column: '已連結',
      indicatorTooltip: '已連結的料盤 — 線材資料與其群組共用',
      linkTitle: '連結料盤',
      pickSourceHint: '選擇要以其線材資料為準的料盤。其品牌、顏色、重量、溫度、價格和備註將複製到其他料盤，並從此保持同步。剩餘重量、標籤、位置和歷史紀錄始終各自獨立。',
      searchPlaceholder: '搜尋料盤…',
      noCandidates: '沒有可選擇的料盤',
      alreadyLinked: '已連結',
      linkConfirm: '這將覆寫 {{count}} 個料盤的線材資料。',
      linkAction: '連結',
      linkedToast: '已連結 — 已更新 {{count}} 筆記錄',
      linkFailed: '連結料盤失敗',
      banner: '已與其他 {{count}} 個料盤連結 — 線材資料的變更將套用至所有連結的料盤。',
      notLinked: '未與其他料盤連結。',
      linkWithExisting: '與現有料盤連結…',
      unlinkAction: '取消連結',
      unlinkedToast: '料盤已取消連結',
      unlinkFailed: '取消連結料盤失敗',
      propagateTitle: '套用至已連結的料盤？',
      propagateConfirm: '此變更也會更新 {{count}} 個已連結料盤的線材資料。剩餘重量、標籤、位置和歷史紀錄不受影響。',
    },
  ...
  confirmOutcome: {
    ...
    savedReject: '已標記為不良',
    saveFailed: '無法儲存判定結果',
    rejectReason: '不良原因（選填）',
    noReason: '無原因',
    saveReject: '儲存',
    rejectAndReprint: '再次列印',
    alreadyGood: '已確認為良品。',
  ...
  paCalibration: {
    ...
    noProfileYet: '尚無設定檔',
    cost: '耗時',
    costValue: '約 {{minutes}} 分鐘，約 {{grams}} 公克',
    plateType: '熱床上的列印板',
    plateTypeHint: '線條依此列印板切片，必須與熱床上實際使用的列印板一致。',
    presetsHint: '使用這些預設切片。第三方耗材請選擇對應的耗材預設。',
    plateConfirm: '列印板已清空，列印出的線條稍後可以清除。',
    start: '開始校準',
    save: '儲存到印表機',
    discard: '捨棄',
    cancelPrintConfirm: '要停止校準列印嗎？',
    oldK: '已儲存 K 值',
    newK: '量測 K 值',
    nCoef: '流量係數',
    confidence: '信賴度',
    willOverwrite: '儲存會取代現有的 K 值設定檔。',
    willCreate: '儲存會新建一個 K 值設定檔並綁定到該料槽。',
    notLoaded: '未裝入任何料槽',
    noPermission: '您沒有在這台印表機上啟動列印的權限。',
    blocked: {
      model_not_supported: '此印表機暫不支援。',
      printer_offline: '印表機已離線。',
      printer_busy: '印表機正在列印。',
      printer_reserved: '印表機已被其他工作占用。',
      run_already_active: '該印表機上已有一次校準在進行。',
      slicer_not_configured: '切片服務無法連線。該校準是一次切片列印，必須依賴它。',
      slot_empty: '該料槽中沒有已辨識的耗材。',
      nozzle_unknown: '印表機尚未回報目前安裝的噴嘴。',
      printer_preset_unavailable: '切片器沒有適用於該印表機與噴嘴的內建設定檔。',
    },
    status: {
      queued: '等待印表機',
      slicing: '切片中',
      uploading: '上傳中',
      printing: '列印中',
      reading_result: '讀取結果中',
      awaiting_confirmation: '等待你的決定',
      saving: '正在儲存到印表機',
      done: '已儲存',
      failed: '已失敗',
      cancelled: '已取消',
    ...
    waiting: {
      printer_offline: '等待印表機重新上線',
      printer_busy: '等待印表機完成目前工作',
      printer_reserved: '等待佇列釋放印表機',
      plate_not_cleared: '等待確認列印板已清空',
    },
    plates: {
      cool_plate: '冷板',
      eng_plate: '工程板',
      hot_plate: '光面 PEI 板',
      textured_plate: '紋理 PEI 板',
    },
    preset: {
      printer: '印表機預設',
      process: '製程預設',
  ...
  notifications: {
    ...
    printConfirmRequest: '成品結果確認',
    printConfirmRequestDescription: '已選擇加入的列印完成後，透過一鍵連結詢問良品／不良判定',
    plateClear: '熱床確認',
    ...
    paCalibration: '校準',
    paCalibrationTitle: '流量動態校準',
    paCalibrationDescription: '壓力提前量量測完成、等待儲存，或本次執行已結束',
