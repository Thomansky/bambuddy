export default {
  ...
  settings: {
    ...
    rfidAfterPrintDescription: '같은 읽기를 반대쪽에서 수행합니다. 인쇄가 끝나면 프린터는 비어 있고 AMS가 필라멘트를 움직일 수 있으며 결과를 기다리는 작업도 없습니다. 완료든 실패든 모든 인쇄 후에 실행되고, 노즐에 아직 장착된 스풀은 건너뛰며, 새 인쇄가 시작되면 즉시 중단합니다. 자동 전원 끄기는 읽기가 끝날 때까지 기다립니다.',
