export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: '유량 역학 캘리브레이션이 끝나기를 기다리는 중',
  ...
  archives: {
    ...
    filterUnconfirmedTitle: '결과 판정을 기다리는 인쇄만 표시',
    ...
    card: {
      ...
      failed: '실패',
      confirmPending: '결과는?',
      confirmPendingTitle: '이 인쇄는 결과 판정을 요청했습니다 — 클릭하여 답변하세요',
      rejected: '불량',
      rejectedTitle: '프린터에서는 완료되었지만 사용자가 불량으로 표시함',
      confirmedGood: '양품',
      confirmedGoodTitle: '사용자가 양품으로 확인함',
      duplicate: '중복',
      ...
      printerWear: '프린터 마모',
      printerWearDetail: '{{hours}}시간 × {{rate}} {{currency}}/시간',
  ...
  stats: {
    ...
    rejectedPrintsCount: '완료 후 불량 처리 {{rejected}}개',
    yieldRate: '수율: {{rate}}%',
  ...
  maintenance: {
    ...
    section: {
      automatic: '자동으로 실행',
      automaticHint: '기한이 되고 프린터가 비어 있으면 Bambuddy가 알아서 실행합니다. 알림만 받습니다.',
      manual: '직접 수행',
      manualHint: '알림입니다. 기한은 Bambuddy가 관리하고, 작업과 완료 처리는 직접 하셔야 합니다.',
    },
    noItems: '아직 설정된 유지보수가 없습니다',
    ...
    calibration: {
      option: {
        bed_leveling: '베드 레벨링',
        vibration: '진동 보정',
        motor_noise: '모터 소음 제거',
        nozzle_offset: '노즐 오프셋',
        high_temp_heatbed: '고온 베드 레벨링',
      ...
      runningSince: '{{time}}부터 캘리브레이션 실행 중',
      nextRunAt: '다음 실행: {{time}}',
      ...
      lastRunCancelled: '마지막 실행 취소됨 {{time}}',
      runQueuedToast: '캘리브레이션이 대기열에 추가됨',
      runCancelledToast: '캘리브레이션 실행이 취소됨',
      runsCalibration: '캘리브레이션 실행',
    },
  },
  settings: {
    sliceEngine: '슬라이스 엔진',
    ...
    autoLinkScannedSpools: '스캔한 스풀 자동 연결',
    autoLinkScannedSpoolsDesc: '스캔되거나 자동 추가된 스풀이 기존 제품과 일치하면 해당 스풀에 연결하여 kg당 가격을 포함한 전체 필라멘트 데이터와 함께 등록되도록 합니다.',
    ...
    rfidAfterPrintLabel: '인쇄 후 식별되지 않은 AMS 스풀 읽기',
    rfidAfterPrintDescription: '같은 읽기를 반대쪽에서 수행합니다. 인쇄가 끝나면 프린터는 비어 있고 AMS가 필라멘트를 움직일 수 있으며 결과를 기다리는 작업도 없습니다. 완료든 실패든 모든 인쇄 후에 실행됩니다. AMS는 아무것도 장착되지 않았을 때만 읽을 수 있으므로(프린터는 보통 인쇄가 끝나면 필라멘트를 빼냅니다) 노즐에 스풀이 남아 있는 프린터는 다음 인쇄 뒤로 미룹니다. 새 인쇄가 시작되면 즉시 중단하며, 자동 전원 끄기는 읽기가 끝날 때까지 기다립니다.',
    rfidAfterPrintUnloadLabel: '읽기 전에 언로드',
    rfidAfterPrintUnloadDescription: '인쇄가 끝났을 때 아직 필라먼트가 장착된 프린터는 태그를 읽을 수 없습니다. AMS가 태그에 닿으려면 필라먼트를 움직여야 하기 때문입니다. 이 옵션을 켜면 먼저 필라먼트를 AMS로 되감은 뒤 읽기를 수행합니다. 이후 프린터는 언로드된 상태로 두며, 다음 인쇄가 필요한 것을 장착합니다. 이미 필라먼트를 뺀 프린터(보통의 경우)에는 언로드 명령을 보내지 않습니다.',
    ...
    suppliers: {
      title: '공급업체',
      description: '필라멘트 구매처를 관리합니다. 제조사를 뜻하는 브랜드와는 다른 개념입니다. 스풀 대화상자에서 스풀에 공급업체를 할당할 수 있으며, 스풀에 할당된 공급업체는 삭제할 수 없습니다.',
      search: '공급업체 검색...',
      addNew: '새 공급업체 추가',
      namePlaceholder: '이름 (예: Filament24)',
      websitePlaceholder: '웹사이트 / 쇼핑몰 URL',
      customerNumberPlaceholder: '고객 번호',
      notePlaceholder: '메모',
      nameRequired: '이름은 필수입니다',
      customerNumber: '고객 번호',
      spools: '스풀',
      noMatch: '검색과 일치하는 공급업체가 없습니다',
      empty: '아직 공급업체가 없습니다',
      added: '공급업체가 추가되었습니다',
      addFailed: '공급업체 추가에 실패했습니다',
      updated: '공급업체가 수정되었습니다',
      updateFailed: '공급업체 수정에 실패했습니다',
      deleted: '공급업체가 삭제되었습니다',
      deleteFailed: '공급업체 삭제에 실패했습니다',
      deleteBlocked: '삭제할 수 없습니다: 아직 스풀 {{count}}개에 할당되어 있습니다',
      loadFailed: '공급업체를 불러오지 못했습니다',
      deleteTitle: '공급업체 삭제',
      deleteConfirm: '"{{name}}"을(를) 삭제하시겠습니까?',
      deleteConfirmReferenced: '"{{name}}"이(가) 스풀 {{count}}개에 할당되어 있습니다. 해당 할당을 제거할 때까지 삭제할 수 없습니다.',
    },
    catalog: {
    ...
    libraryRootView: '루트에 표시할 내용',
    libraryRootViewAll: '모든 파일',
    libraryRootViewAllDescription: '라이브러리의 모든 파일을 하나의 평면 목록으로 표시합니다.',
    libraryRootViewFolders: '폴더만',
    libraryRootViewFoldersDescription: '최상위 폴더와, 어느 폴더에도 속하지 않는 파일을 위한 「폴더 없음」 항목을 표시합니다.',
    libraryRootViewRecent: '최근에 추가하거나 변경한 항목',
    libraryRootViewRecentDescription: '라이브러리 전체에서 가장 최근 파일을 최대 100개. 목록이 아니라 시작 페이지입니다.',
    libraryRootViewDescription: '검색과 태그 필터는 무엇을 선택하든 항상 라이브러리 전체를 대상으로 합니다.',
    webdavMode: 'WebDAV 접근',
    webdavDescription: '파일 관리자 트리를 WebDAV로 제공하여 워크스테이션에서 드라이브로 연결할 수 있게 합니다.',
    webdavModeOff: '끄기',
    webdavModeOffDescription: '주소가 404를 반환합니다. 이 기능이 없던 설치와 똑같이 동작합니다.',
    webdavModeRead: '읽기 전용',
    webdavModeReadDescription: '파일을 열고 복사할 수 있습니다. 연결한 드라이브에서 한 작업은 라이브러리를 바꾸지 않습니다.',
    webdavModeReadWrite: '읽기 및 쓰기',
    webdavModeReadWriteDescription: '드라이브에서 저장, 이름 변경, 이동, 삭제도 가능하며 웹 화면과 동일한 라이브러리 권한이 적용됩니다.',
    webdavAddressHint: '{{url}} 을(를) 연결하세요. 공유에는 관리 라이브러리를 위한 ‘Files’와, 외부 폴더가 등록되어 있으면 ‘External’이 있습니다.',
    webdavCredentialsHint: '웹 UI가 로그인 없이 동작하는 설치에서도 항상 Bambuddy 사용자 이름과 비밀번호를 요구하며, 각 사용자는 읽을 수 있는 파일만 보게 됩니다.',
    webdavTwoFactorHint: '2단계 인증을 사용하는 계정은 이 공유를 열 수 없습니다. Basic 인증으로는 두 번째 코드를 물을 방법이 없기 때문입니다. 잘못된 비밀번호는 웹 로그인과 동일한 잠금에 합산됩니다.',
    webdavHttpsHint: 'Basic 자격 증명이 모든 요청마다 함께 전송되므로 HTTPS로 제공하세요.',
    webdavWindowsHint: 'Windows는 HKLM\\SYSTEM\\CurrentControlSet\\Services\\WebClient\\Parameters\\BasicAuthLevel 값이 2가 되기 전까지 일반 HTTP에서의 Basic 인증을 거부합니다. HTTPS에서는 그대로 동작합니다.',
    webdavWriteHint: '덮어써도 라이브러리 항목은 그대로 유지되어 태그와 메모를 지키고 내용만 바뀝니다. 버전도 변형도 만들지 않습니다. 삭제한 파일은 휴지통으로 이동하고, 드라이브에서 만든 폴더에는 번호가 부여되지 않습니다.',
    libraryStorageMode: '라이브러리 저장 위치',
    libraryStorageDescription: '파일 관리자가 파일을 두는 곳입니다. Bambuddy 자체 저장소 또는 색인만 만드는 디렉터리 트리 중 하나입니다.',
    libraryStorageModeManaged: 'Bambuddy 자체 라이브러리',
    libraryStorageModeManagedDescription: '파일은 Bambuddy 데이터 디렉터리에 있고 Bambuddy를 통해서만 접근합니다. 외부에서 옮길 수 없으므로 데이터베이스와 디스크가 항상 일치합니다.',
    libraryStorageModeDirectory: '디렉터리',
    libraryStorageModeDirectoryDescription: '직접 고른 디렉터리(보통 네트워크 공유)가 라이브러리 자체가 됩니다. 모든 폴더는 실제 디렉터리이고 파일은 본래 이름을 유지하므로 같은 트리를 탐색기에서 열 수 있습니다.',
    libraryStoragePath: '디렉터리 경로',
    libraryStoragePathHint: 'Bambuddy 서버가 보는 절대 경로이므로 공유는 먼저 그곳에 마운트되어 있어야 합니다. 존재하고, 쓸 수 있고, Bambuddy 자체 데이터 디렉터리 밖에 있어야 합니다.',
    libraryStorageDriftHint: '디렉터리에서 직접 옮기거나 지운 것은 폴더를 검사할 때까지 Bambuddy에 보이지 않습니다. 따라서 검사는 한 번으로 끝나는 일이 아니라 일상적인 작업이 됩니다.',
    libraryStorageHashHint: '검사로 찾은 파일은 해시를 만들지 않습니다. 공유의 모든 파일을 읽으려면 전체를 한 번 훑어야 하기 때문이며, 그래서 중복 검출에 참여하지 않습니다. Bambuddy를 통해 기록된 파일은 이전처럼 해시됩니다.',
    libraryStorageMigration: '기존 라이브러리를 디렉터리로 옮기기',
    libraryStorageMigrationHint: '모드를 바꾸는 것만으로는 아무것도 옮겨지지 않습니다. 여기서는 각 파일을 트리의 제자리에 복사하고 복사본을 확인한 뒤에야 원본을 지웁니다. 언제든 다시 실행할 수 있고 남은 것을 옮깁니다.',
    libraryStoragePlanButton: '옮길 내용 보기',
    libraryStorageMigrateButton: '지금 옮기기',
    libraryStoragePlanSummary: '파일 {{files}}개, 폴더 {{folders}}개, {{size}} 이동 예정입니다.',
    libraryStorageMigrationDone: '파일 {{files}}개를 옮기고 디렉터리 {{folders}}개를 만들었습니다.',
    ...
    libraryStorageScanDone: '검사 완료: {{added}}개 추가, {{removed}}개 제거.',
    ...
    libraryStorageBlockerExists: '{{name}} 이(가) 이미 그곳에 있습니다. 공유에서 옮기거나 이름을 바꾸세요.',
    storageUsageLibraryTree: '라이브러리 파일은 {{path}} 에 있습니다.',
    storageUsageLibraryTreeFree: '{{total}} 중 {{free}} 남음',
  ...
  fileManager: {
    ...
    renderingPreviews: '미리보기 생성 중… {{done}}/{{total}}',
    ...
    noFolder: '폴더 없음',
    recentCrumb: '최근',
    sortedByRecent: '추가 또는 변경 시점 순으로 정렬',
    pathBar: {
      label: '위치',
      showHidden: '생략된 폴더 표시',
      editPath: '경로 편집',
      noSuchFolder: '그런 폴더가 없습니다',
      siblings: '이 단계의 폴더',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        date: '날짜',
        attachments: '첨부 파일',
        noBody: '이 메시지에는 텍스트 본문이 없습니다.',
        rtfNote: '서식 있는 텍스트 콘텐츠에서 추출한 텍스트입니다. 서식이 단순화되었습니다.',
      },
    },
    details: {
      title: '파일 세부 정보',
    ...
    toast: {
      ...
      previewsRendered: '브라우저에서 미리보기 {{count}}개를 생성했습니다',
  ...
  inventory: {
    ...
    vatInclShort: '포함',
    vatExclShort: '제외',
    vatConvertedIncl: '= {{value}} 부가세 포함',
    vatConvertedExcl: '= {{value}} 부가세 제외',
    ...
    suppliers: {
      ...
      noneLeft: '모든 공급업체가 이미 할당되었습니다',
      createNew: '"{{name}}" 만들기',
      createFailed: '공급업체 생성에 실패했습니다',
      purchaseSource: '구매처',
      purchaseSourceHelp: '이 스풀을 실제로 구매한 곳을 표시합니다. 나머지 항목은 대체 구매처입니다.',
      articleNumberPlaceholder: '공급업체 품목 번호',
      pricePlaceholder: '견적 가격/kg',
      priceHelp: '이 공급업체의 견적 가격으로, 구매처 비교용입니다. 스풀 자체의 kg당 비용이 실제 원가 기준으로 유지됩니다.',
      help: '이 제품을 구매할 수 있는 곳입니다. 강조 표시된 항목이 이 스풀을 구매한 곳입니다.',
      saveFailed: '공급업체 할당 저장에 실패했습니다',
    },
    linked: {
      column: '연결됨',
      indicatorTooltip: '연결된 스풀 — 필라멘트 데이터가 그룹과 공유됩니다',
      linkTitle: '스풀 연결',
      pickSourceHint: '필라멘트 데이터의 기준이 될 스풀을 선택하세요. 해당 스풀의 브랜드, 색상, 무게, 온도, 가격, 메모가 다른 스풀에 복사되며 이후 계속 동기화됩니다. 남은 무게, 태그, 위치, 기록은 항상 스풀별로 유지됩니다.',
      searchPlaceholder: '스풀 검색…',
      noCandidates: '선택할 수 있는 스풀이 없습니다',
      alreadyLinked: '연결됨',
      linkConfirm: '스풀 {{count}}개의 필라멘트 데이터를 덮어씁니다.',
      linkAction: '연결',
      linkedToast: '연결됨 — 레코드 {{count}}개 업데이트됨',
      linkFailed: '스풀 연결에 실패했습니다',
      banner: '다른 스풀 {{count}}개와 연결됨 — 필라멘트 데이터 변경 사항이 모두에게 적용됩니다.',
      notLinked: '다른 스풀과 연결되어 있지 않습니다.',
      linkWithExisting: '기존 스풀과 연결…',
      unlinkAction: '연결 해제',
      unlinkedToast: '스풀 연결이 해제되었습니다',
      unlinkFailed: '스풀 연결 해제에 실패했습니다',
      propagateTitle: '연결된 스풀에도 적용할까요?',
      propagateConfirm: '이 변경 사항은 연결된 스풀 {{count}}개의 필라멘트 데이터도 업데이트합니다. 남은 무게, 태그, 위치, 기록은 그대로 유지됩니다.',
    },
    ...
    totalInventory: '총 재고',
    stockValue: '재고 가치',
    stockValuePurchase: '구매 금액: {{value}}',
    stockValueUnpriced: '가격 미입력 {{count}}개',
    stockValueUnpricedTooltip: 'kg당 가격이 없는 스풀은 가치에 포함되지 않습니다.',
    totalConsumed: '총 소비량',
    byMaterial: '재료별',
    inPrinter: '프린터 내',
    lowStock: '재고 부족',
  ...
  confirmOutcome: {
    ...
    noPhoto: '완료 사진 없음',
    savedGood: '양품으로 표시됨',
    savedReject: '불량으로 표시됨',
    saveFailed: '판정을 저장할 수 없습니다',
    rejectReason: '불량 사유 (선택 사항)',
    noReason: '사유 없음',
    saveReject: '저장',
    rejectAndReprint: '다시 인쇄',
  ...
  paCalibration: {
    ...
    slot: '슬롯',
    currentK: '현재 K값',
    noProfileYet: '아직 프로필 없음',
    cost: '소요',
    costValue: '약 {{minutes}}분, 약 {{grams}} g',
    plateType: '베드에 놓인 빌드 플레이트',
    plateTypeHint: '선은 이 플레이트에 맞춰 슬라이싱되므로 실제로 올려둔 플레이트와 같아야 합니다.',
    presetsHint: '이 프리셋으로 슬라이싱합니다. 타사 필라멘트라면 알맞은 프로필을 선택하세요.',
    plateConfirm: '빌드 플레이트가 비어 있으며 인쇄된 선은 나중에 제거해도 됩니다.',
    start: '캘리브레이션 시작',
    save: '프린터에 저장',
    discard: '버리기',
    cancelPrintConfirm: '캘리브레이션 출력을 중지할까요?',
    oldK: '저장된 K값',
    newK: '측정된 K값',
    nCoef: '유량 계수',
    confidence: '신뢰도',
    willOverwrite: '저장하면 기존 K 프로필을 대체합니다.',
    willCreate: '저장하면 새 K 프로필을 만들어 이 슬롯에 연결합니다.',
    notLoaded: '어느 슬롯에도 장착되지 않음',
    noPermission: '이 프린터에서 인쇄를 시작할 권한이 없습니다.',
    blocked: {
      model_not_supported: '이 프린터에서는 아직 지원되지 않습니다.',
      printer_offline: '프린터가 오프라인입니다.',
      printer_busy: '프린터가 출력 중입니다.',
      printer_reserved: '프린터가 다른 작업에 예약되어 있습니다.',
      run_already_active: '이 프린터에서 이미 캘리브레이션이 진행 중입니다.',
      slicer_not_configured: '슬라이서 서비스에 연결할 수 없습니다. 이 캘리브레이션은 슬라이싱된 출력이라 반드시 필요합니다.',
      slot_empty: '슬롯에 식별된 필라멘트가 없습니다.',
      nozzle_unknown: '어떤 노즐이 장착됐는지 프린터가 알려주지 않았습니다.',
      printer_preset_unavailable: '이 프린터와 노즐에 맞는 기본 프로필이 슬라이서에 없습니다.',
    },
    status: {
      queued: '프린터 대기 중',
      slicing: '슬라이싱 중',
      uploading: '업로드 중',
      printing: '출력 중',
      reading_result: '결과 읽는 중',
      awaiting_confirmation: '결정을 기다리는 중',
      saving: '프린터에 저장 중',
      done: '저장됨',
      failed: '실패',
      cancelled: '취소됨',
    ...
    waiting: {
      printer_offline: '프린터가 다시 연결되기를 기다리는 중',
      printer_busy: '프린터가 현재 작업을 마치기를 기다리는 중',
      printer_reserved: '대기열이 프린터를 놓아주기를 기다리는 중',
      plate_not_cleared: '빌드 플레이트가 비었다는 확인을 기다리는 중',
    },
    plates: {
      cool_plate: '쿨 플레이트',
      eng_plate: '엔지니어링 플레이트',
      hot_plate: '매끄러운 PEI 플레이트',
      textured_plate: '텍스처 PEI 플레이트',
    },
    preset: {
      printer: '프린터 프리셋',
      process: '프로세스 프리셋',
  ...
  notifications: {
    ...
    printConfirmRequest: '결과 확인',
    printConfirmRequestDescription: '참여 설정된 인쇄가 완료되면 원탭 링크로 양품/불량 판정을 요청합니다',
    plateClear: '플레이트 확인',
    ...
    paCalibration: '캘리브레이션',
    paCalibrationTitle: '흐름 역학 캘리브레이션',
    paCalibrationDescription: '압력 선행 측정이 끝나 저장을 기다리거나 실행이 종료되었습니다',
