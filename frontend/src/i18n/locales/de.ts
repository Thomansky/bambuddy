export default {
  ...
  printers: {
    ...
    modal: {
      ...
      expectedLifetimeHours: 'Erwartete Lebensdauer (Stunden)',
      depreciationHelp: 'Berechnet zukünftigen Drucken den Druckerverschleiß pro Druckstunde. Beide Felder leer lassen, um zu deaktivieren.',
      depreciationRate: '≈ {{rate}} {{currency}}/h Druckerverschleiß',
