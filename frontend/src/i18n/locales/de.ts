export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: 'Warten, bis eine Fließdynamik-Kalibrierung beendet ist',
  ...
  archives: {
    ...
    filterUnconfirmed: 'Unbestätigt',
    filterUnconfirmedTitle: 'Nur Drucke anzeigen, die noch auf ihre Ergebnis-Bewertung warten',
    ...
    card: {
      ...
      printerWear: 'Druckerverschleiß',
      printerWearDetail: '{{hours}} Std. × {{rate}} {{currency}}/Std.',
  ...
  stats: {
    ...
    suppliers: {
      ...
      empty: 'Noch keine Käufe erfasst. Markieren Sie an einer Spule, bei welchem Lieferanten sie gekauft wurde, um Verbrauch und Kosten hier zu gruppieren.',
      supplier: 'Lieferant',
      spools: 'Spulen',
      remaining: 'Verbleibend',
      consumed: 'Verbraucht',
    ...
    rejectedPrintsCount: '{{rejected}} nach Abschluss als Ausschuss markiert',
    yieldRate: 'Ausbeute: {{rate}}%',
  ...
  maintenance: {
    ...
    section: {
      automatic: 'Läuft von selbst',
      automaticHint: 'Bambuddy startet diese am Drucker, sobald sie fällig und er frei ist — du wirst nur benachrichtigt.',
      manual: 'Machst du selbst',
      manualHint: 'Eine Erinnerung. Bambuddy verfolgt die Fälligkeit; Arbeit und Abhaken bleiben bei dir.',
    },
    noItems: 'Noch keine Wartung eingerichtet',
    ...
    calibration: {
      option: {
        bed_leveling: 'Bettnivellierung',
        vibration: 'Vibrationskompensation',
        motor_noise: 'Motorgeräuschunterdrückung',
        nozzle_offset: 'Düsenversatz',
        high_temp_heatbed: 'Hochtemperatur-Bettnivellierung',
        micro_lidar: 'Micro Lidar',
        nozzle_clumping: 'Düsenverklumpungs-Erkennung',
      },
      bedTempBelow: 'Nur wenn das Druckbett unter',
      ...
      triggerSchedule: 'Nach Zeitplan',
      triggerGatePlateClear: '(nur wenn die Druckplatte freigegeben wurde)',
      ...
      runningSince: 'Kalibrierung läuft seit {{time}}',
      ...
      lastRunCancelled: 'Letzter Lauf abgebrochen {{time}}',
      runQueuedToast: 'Kalibrierung eingereiht',
      runCancelledToast: 'Kalibrierungslauf abgebrochen',
      runsCalibration: 'Führt eine Kalibrierung aus',
    },
  },
  ...
  settings: {
    ...
    // Linked spools (#2936)
    autoLinkScannedSpools: 'Gescannte Spulen automatisch verknüpfen',
    autoLinkScannedSpoolsDesc: 'Wenn eine gescannte oder automatisch hinzugefügte Spule einem vorhandenen Produkt entspricht, wird sie mit dieser Spule verknüpft und erhält so die vollständigen Filamentdaten — inklusive Preis pro kg.',
    ...
    suppliers: {
      title: 'Lieferanten',
      description: 'Verwalten Sie, wo Sie Filament kaufen — nicht zu verwechseln mit der Marke, also dem Hersteller. Weisen Sie Spulen im Spulendialog Lieferanten zu; ein Lieferant, der noch Spulen zugewiesen ist, kann nicht gelöscht werden.',
      search: 'Lieferanten durchsuchen...',
      addNew: 'Neuen Lieferanten hinzufügen',
      namePlaceholder: 'Name (z. B. Filament24)',
      websitePlaceholder: 'Website / Shop-URL',
      customerNumberPlaceholder: 'Kundennr.',
      ...
      addFailed: 'Lieferant konnte nicht hinzugefügt werden',
      updated: 'Lieferant aktualisiert',
      updateFailed: 'Lieferant konnte nicht aktualisiert werden',
      deleted: 'Lieferant gelöscht',
      deleteFailed: 'Lieferant konnte nicht gelöscht werden',
      deleteBlocked: 'Löschen nicht möglich: noch {{count}} Spule(n) zugewiesen',
      loadFailed: 'Lieferanten konnten nicht geladen werden',
      deleteTitle: 'Lieferant löschen',
      deleteConfirm: '"{{name}}" löschen?',
      deleteConfirmReferenced: '"{{name}}" ist {{count}} Spule(n) zugewiesen. Das Löschen ist blockiert, bis diese Zuordnungen entfernt wurden.',
    },
    catalog: {
    ...
    libraryRootView: 'Was die Stammebene zeigt',
    libraryRootViewAll: 'Alle Dateien',
    libraryRootViewAllDescription: 'Jede Datei der Bibliothek in einer flachen Liste.',
    libraryRootViewFolders: 'Nur Ordner',
    libraryRootViewFoldersDescription: 'Die obersten Ordner, dazu ein Eintrag „Ohne Ordner“ für Dateien außerhalb jedes Ordners.',
    libraryRootViewRecent: 'Zuletzt hinzugefügt oder geändert',
    libraryRootViewRecentDescription: 'Die neuesten Dateien der gesamten Bibliothek, höchstens 100 - eine Startseite statt einer Liste.',
    libraryRootViewDescription: 'Suche und Tag-Filter durchsuchen immer die gesamte Bibliothek, egal welche der drei Möglichkeiten gewählt ist.',
    webdavMode: 'WebDAV-Zugriff',
    webdavDescription: 'Den Dateimanager-Baum über WebDAV bereitstellen, damit ein Arbeitsplatz ihn als Laufwerk einbinden kann.',
    webdavModeOff: 'Aus',
    webdavModeOffDescription: 'Die Adresse antwortet mit 404 – genau wie auf einer Installation, die die Funktion nie hatte.',
    webdavModeRead: 'Nur lesen',
    webdavModeReadDescription: 'Dateien lassen sich öffnen und kopieren; nichts, was am eingebundenen Laufwerk passiert, verändert die Bibliothek.',
    webdavModeReadWrite: 'Lesen und schreiben',
    webdavModeReadWriteDescription: 'Zusätzlich Speichern, Umbenennen, Verschieben und Löschen vom Laufwerk aus – mit denselben Bibliotheksrechten, die auch die Weboberfläche anwendet.',
    ...
    webdavHttpsHint: 'Über HTTPS bereitstellen, denn die Basic-Zugangsdaten gehen bei jeder einzelnen Anfrage mit.',
    ...
    webdavWriteHint: 'Beim Überschreiben bleibt derselbe Bibliothekseintrag mit seinen Tags und Notizen erhalten, nur der Inhalt wird ersetzt – keine Version, keine Variante. Gelöschte Dateien wandern in den Papierkorb, und ein vom Laufwerk aus angelegter Ordner erhält keine Nummer.',
    libraryStorageMode: 'Ablage der Bibliothek',
    libraryStorageDescription: 'Wo der Dateimanager seine Dateien hält: in Bambuddys eigener Ablage oder in einem Verzeichnisbaum, den es nur indexiert.',
    libraryStorageModeManaged: 'Eigene Bibliothek',
    libraryStorageModeManagedDescription: 'Die Dateien liegen im Bambuddy-Datenverzeichnis und sind nur über Bambuddy erreichbar. Von außen kann sie niemand verschieben, deshalb stimmen Datenbank und Datenträger immer überein.',
    libraryStorageModeDirectory: 'Verzeichnis',
    libraryStorageModeDirectoryDescription: 'Ein Verzeichnis deiner Wahl — meist eine Netzwerkfreigabe — wird selbst zur Bibliothek: jeder Ordner ist ein echtes Verzeichnis, jede Datei behält ihren echten Namen, und derselbe Baum lässt sich im Explorer öffnen.',
    libraryStoragePath: 'Pfad zum Verzeichnis',
    libraryStoragePathHint: 'Absoluter Pfad, so wie der Bambuddy-Server ihn sieht — eine Freigabe muss dort also erst eingebunden sein. Er muss existieren, beschreibbar sein und außerhalb der Bambuddy-Datenverzeichnisse liegen.',
    libraryStorageDriftHint: 'Was direkt im Verzeichnis verschoben oder gelöscht wird, sieht Bambuddy erst nach einem Scan des Ordners. Scannen gehört damit zum Alltag und ist keine Einmalsache mehr.',
    libraryStorageHashHint: 'Dateien, die ein Scan findet, werden nicht gehasht — jede Datei einer Freigabe zu lesen kostet einen kompletten Durchlauf — und nehmen deshalb nicht an der Duplikaterkennung teil. Über Bambuddy geschriebene Dateien werden wie bisher gehasht.',
    libraryStorageMigration: 'Bestehende Bibliothek ins Verzeichnis umziehen',
    libraryStorageMigrationHint: 'Das Umschalten allein verschiebt nichts. Hier wird jede Datei an ihren Platz im Baum kopiert, die Kopie geprüft und erst danach das Original entfernt. Der Vorgang lässt sich jederzeit erneut starten und holt dann nach, was noch fehlt.',
    libraryStoragePlanButton: 'Anzeigen, was umzieht',
    libraryStorageMigrateButton: 'Jetzt umziehen',
    libraryStoragePlanSummary: '{{files}} Datei(en), {{folders}} Ordner, {{size}} zu verschieben.',
    libraryStorageMigrationDone: '{{files}} Datei(en) verschoben, {{folders}} Verzeichnis(se) angelegt.',
    ...
    libraryStorageScanDone: 'Scan fertig: {{added}} hinzugefügt, {{removed}} entfernt.',
    ...
    libraryStorageBlockerExists: '{{name}} liegt dort schon. Verschiebe oder benenne sie auf der Freigabe um.',
    storageUsageLibraryTree: 'Die Bibliotheksdateien liegen auf {{path}}.',
    storageUsageLibraryTreeFree: '{{free}} von {{total}} frei',
    // Updates
  ...
  fileManager: {
    ...
    renderingPreviews: 'Vorschauen werden erzeugt … {{done}}/{{total}}',
    ...
    recentCrumb: 'Zuletzt',
    sortedByRecent: 'Nach Hinzufügen oder Änderung sortiert',
    pathBar: {
      label: 'Pfad',
      showHidden: 'Ausgeblendete Ordner anzeigen',
      editPath: 'Pfad bearbeiten',
      noSuchFolder: 'Diesen Ordner gibt es nicht',
      siblings: 'Ordner dieser Ebene',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        date: 'Datum',
        attachments: 'Anhänge',
        noBody: 'Diese Nachricht enthält keinen Textinhalt.',
        rtfNote: 'Text aus Rich-Text-Inhalt extrahiert — Formatierung vereinfacht.',
      },
    },
    details: {
      title: 'Dateidetails',
    ...
    toast: {
      ...
      previewsRendered: '{{count}} Vorschaubild(er) im Browser erzeugt',
  ...
  inventory: {
    ...
    vatInclShort: 'inkl.',
    vatExclShort: 'exkl.',
    vatConvertedIncl: '= {{value}} inkl. MwSt.',
    vatConvertedExcl: '= {{value}} exkl. MwSt.',
    ...
    suppliers: {
      ...
      searchPlaceholder: 'Lieferanten durchsuchen…',
      noneLeft: 'Alle Lieferanten sind bereits zugewiesen',
      createNew: '"{{name}}" anlegen',
      createFailed: 'Lieferant konnte nicht angelegt werden',
      purchaseSource: 'Hier gekauft',
      purchaseSourceHelp: 'Markiert, wo diese Spule tatsächlich gekauft wurde; die übrigen Einträge sind alternative Bezugsquellen.',
      articleNumberPlaceholder: 'Artikelnr. des Lieferanten',
      pricePlaceholder: 'Angebotspreis/kg',
      priceHelp: 'Angebotspreis bei diesem Lieferanten, zum Vergleich der Bezugsquellen — der eigene Preis pro kg der Spule bleibt die Kostenbasis.',
      help: 'Wo dieses Produkt gekauft werden kann. Der hervorgehobene Eintrag ist die Bezugsquelle dieser Spule.',
      saveFailed: 'Lieferantenzuordnungen konnten nicht gespeichert werden',
    },
    // Linked spools sharing filament master data (#2936)
    linked: {
      column: 'Verknüpft',
      indicatorTooltip: 'Verknüpfte Spule — Filamentdaten werden mit ihrer Gruppe geteilt',
      linkTitle: 'Spulen verknüpfen',
      pickSourceHint: 'Wählen Sie die Spule, deren Filamentdaten übernommen werden sollen. Marke, Farbe, Gewichte, Temperaturen, Preis und Notizen werden auf die anderen kopiert und bleiben ab dann synchron. Restgewicht, Tags, Lagerorte und Verlauf bleiben immer je Spule erhalten.',
      searchPlaceholder: 'Spulen suchen…',
      noCandidates: 'Keine Spulen zur Auswahl',
      alreadyLinked: 'verknüpft',
      linkConfirm: 'Dadurch werden die Filamentdaten von {{count}} Spule(n) überschrieben.',
      linkAction: 'Verknüpfen',
      linkedToast: 'Verknüpft — {{count}} Einträge aktualisiert',
      linkFailed: 'Spulen konnten nicht verknüpft werden',
      banner: 'Mit {{count}} weiteren Spule(n) verknüpft — Änderungen an den Filamentdaten gelten für alle.',
      notLinked: 'Nicht mit anderen Spulen verknüpft.',
      linkWithExisting: 'Mit vorhandener Spule verknüpfen…',
      unlinkAction: 'Verknüpfung aufheben',
      unlinkedToast: 'Spulenverknüpfung aufgehoben',
      unlinkFailed: 'Verknüpfung der Spule konnte nicht aufgehoben werden',
      propagateTitle: 'Auf verknüpfte Spulen anwenden?',
      propagateConfirm: 'Diese Änderung aktualisiert auch die Filamentdaten von {{count}} verknüpften Spule(n). Restgewicht, Tags, Lagerorte und Verlauf bleiben unberührt.',
    },
  ...
  confirmOutcome: {
    title: 'Wie ist Ihr Druck geworden?',
    good: 'Gut',
    reject: 'Ausschuss',
    later: 'Später fragen',
    noPhoto: 'Kein Abschlussfoto verfügbar',
    savedGood: 'Als Gutteil markiert',
    savedReject: 'Als Ausschuss markiert',
    saveFailed: 'Bewertung konnte nicht gespeichert werden',
    rejectReason: 'Ausschussgrund (optional)',
    noReason: 'Kein Grund',
    saveReject: 'Speichern',
  ...
  editArchive: {
    ...
    status: 'Status',
    userVerdict: 'Ergebnis-Bewertung',
    verdicts: {
  ...
  // Virtual Printer
  paCalibration: {
    title: 'Fließdynamik-Kalibrierung',
    menuAction: 'Fließdynamik kalibrieren…',
    printer: 'Drucker',
    nozzle: 'Düse',
    slot: 'Fach',
    currentK: 'Aktueller K-Wert',
    noProfileYet: 'Noch kein Profil',
    cost: 'Dauert',
    costValue: 'etwa {{minutes}} Min., etwa {{grams}} g',
    plateType: 'Druckplatte auf dem Bett',
    plateTypeHint: 'Die Linie wird für diese Platte gesliced und muss zu der Platte passen, die wirklich aufliegt.',
    presetsHint: 'Wird mit diesen Voreinstellungen gesliced. Für Fremdfilament das passende Filamentprofil wählen.',
    plateConfirm: 'Die Druckplatte ist leer und die gedruckte Linie darf danach entfernt werden.',
    start: 'Kalibrierung starten',
    save: 'Auf Drucker speichern',
    discard: 'Verwerfen',
    cancelPrintConfirm: 'Kalibrierdruck stoppen?',
    oldK: 'Gespeicherter K-Wert',
    newK: 'Gemessener K-Wert',
    nCoef: 'Flusskoeffizient',
    confidence: 'Vertrauenswert',
    willOverwrite: 'Beim Speichern wird das vorhandene K-Profil ersetzt.',
    willCreate: 'Beim Speichern wird ein neues K-Profil angelegt und diesem Fach zugewiesen.',
    notLoaded: 'In keinem Fach geladen',
    noPermission: 'Sie haben keine Berechtigung, auf diesem Drucker einen Druck zu starten.',
    blocked: {
      model_not_supported: 'Für diesen Drucker noch nicht unterstützt.',
      printer_offline: 'Der Drucker ist offline.',
      printer_busy: 'Der Drucker druckt gerade.',
      printer_reserved: 'Der Drucker ist für einen anderen Auftrag reserviert.',
      run_already_active: 'Auf diesem Drucker läuft bereits eine Kalibrierung.',
      slicer_not_configured: 'Der Slicer-Dienst ist nicht erreichbar. Diese Kalibrierung ist ein geslicter Druck und braucht ihn.',
      slot_empty: 'Im Fach liegt kein erkanntes Filament.',
      nozzle_unknown: 'Der Drucker hat nicht gemeldet, welche Düse montiert ist.',
      printer_preset_unavailable: 'Der Slicer hat kein mitgeliefertes Profil für diesen Drucker und diese Düse.',
    },
    status: {
      queued: 'Wartet auf den Drucker',
      slicing: 'Wird gesliced',
      uploading: 'Wird übertragen',
      printing: 'Druckt',
      reading_result: 'Ergebnis wird gelesen',
      awaiting_confirmation: 'Wartet auf Ihre Entscheidung',
      saving: 'Wird auf dem Drucker gespeichert',
      done: 'Gespeichert',
      failed: 'Fehlgeschlagen',
      cancelled: 'Abgebrochen',
    },
    waiting: {
      printer_offline: 'Wartet, bis der Drucker wieder online ist',
      printer_busy: 'Wartet, bis der Drucker den laufenden Auftrag beendet hat',
      printer_reserved: 'Wartet, bis die Warteschlange den Drucker freigibt',
      plate_not_cleared: 'Wartet auf die Bestätigung, dass die Druckplatte leer ist',
    },
    plates: {
      cool_plate: 'Kalte Platte',
      eng_plate: 'Engineering-Platte',
      hot_plate: 'Glatte PEI-Platte',
      textured_plate: 'Strukturierte PEI-Platte',
    },
    preset: {
      printer: 'Druckerprofil',
      process: 'Prozessprofil',
  ...
  notifications: {
    ...
    printConfirmRequest: 'Ergebnis-Bestätigung',
    printConfirmRequestDescription: 'Gut/Ausschuss-Bewertung mit Ein-Klick-Links anfordern, wenn ein dafür aktivierter Druck abgeschlossen wird',
    ...
    maintenanceRun: 'Wartungslauf abgeschlossen',
    maintenanceRunDescription: 'Benachrichtigen, wenn ein von Bambuddy gestarteter Kalibrierungslauf abgeschlossen, fehlgeschlagen oder abgebrochen wurde',
    ...
    paCalibration: 'Kalibrierung',
    paCalibrationTitle: 'Fließdynamik-Kalibrierung',
    paCalibrationDescription: 'Eine Pressure-Advance-Messung ist fertig und wartet auf das Speichern, oder der Lauf ist beendet',
    ...
    eventTypes: {
      ...
      maintenance_run: 'Wartungslauf abgeschlossen',
      test: 'Test',
    },
