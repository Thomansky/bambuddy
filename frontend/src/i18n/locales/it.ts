export default {
  ...
  printers: {
    ...
    modal: {
      ...
      purchasePrice: 'Prezzo d\'acquisto (opzionale)',
      expectedLifetimeHours: 'Durata prevista (ore)',
      depreciationHelp: 'Addebita l\'usura della stampante per ora di stampa alle stampe future. Lascia vuoti entrambi i campi per disattivare.',
      depreciationRate: '≈ {{rate}} {{currency}}/h di usura della stampante',
