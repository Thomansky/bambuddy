export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: 'In attesa che termini una calibrazione della dinamica di flusso',
  ...
  archives: {
    ...
    filterUnconfirmed: 'Non confermate',
    filterUnconfirmedTitle: 'Mostra solo le stampe ancora in attesa del verdetto sull\'esito',
    ...
    card: {
      ...
      printerWear: 'Usura della stampante',
      printerWearDetail: '{{hours}} h × {{rate}} {{currency}} all\'ora',
  ...
  queue: {
    ...
    maintenanceHold: {
      run: 'Manutenzione in attesa: {{item}} ({{state}})',
      schedule: 'Manutenzione programmata {{when}} — questo lavoro vi sconfinerebbe (stimato {{duration}})',
      scheduleUnknown: 'Manutenzione programmata {{when}} — questo lavoro vi sconfinerebbe (durata sconosciuta)',
      state: {
        queued: 'in coda',
        running: 'in corso',
        printerOffline: 'stampante offline',
        printerBusy: 'stampante occupata',
        plateClear: 'piatto non ancora liberato',
    ...
    badges: {
      ...
      confirmOutcome: 'Richiesta esito',
      confirmOutcomeTitle: 'Chiede com’è venuta la stampa una volta completata',
    },
    // Empty state
    empty: {
  ...
  stats: {
    ...
    rejectedPrintsCount: '{{rejected}} scartate dopo il completamento',
    yieldRate: 'Resa: {{rate}}%',
    ...
    recalculateCostsVatHint: 'I costi bobina registrati al momento della stampa mantengono la base in cui sono stati registrati; vengono riapplicati solo i prezzi di catalogo e predefiniti.',
  ...
  maintenance: {
    ...
    kindCounts: '{{automatic}} automatiche, {{manual}} manuali',
    section: {
      automatic: 'Si esegue da sola',
      automaticHint: 'Bambuddy le avvia sulla stampante quando scadono ed è libera: ricevi solo una notifica.',
      manual: 'La fai tu',
      manualHint: 'Un promemoria. Bambuddy tiene traccia della scadenza; il lavoro e la conferma sono tuoi.',
    },
    noItems: 'Nessuna manutenzione ancora configurata',
    switchedOffCount: '{{count}} disattivati',
    allItemsSwitchedOff: 'Tutti gli elementi di questa stampante sono disattivati',
    coverage: 'su {{used}} di {{total}} stampanti',
    printersButton: 'Stampanti',
    printersPanelTitle: 'Stampanti che usano questo tipo',
    noEligiblePrinters: 'Nessuna stampante può usare questo tipo',
    action: 'Azione',
    actionNone: 'Nessuna (solo promemoria)',
    actionCalibration: 'Calibrazione della stampante',
    actionMotionPrecision: 'Calibrazione del codificatore di visione',
    actionHint: 'Bambuddy esegue questa attività da solo. Non modificabile in seguito.',
    deletedTypes: 'Tipi eliminati',
    noDeletedTypes: 'Niente eliminato',
    deletedAt: 'Eliminato il {{date}}',
    deletedAtUnknown: 'Eliminato in precedenza',
    deletedItemsTitle: 'Elementi stampante conservati',
    restoreType: 'Ripristina',
    typeRestored: 'Tipo di manutenzione ripristinato',
    // Actionable maintenance: printer calibration (#3127)
    calibration: {
      option: {
        bed_leveling: 'Livellamento del piano',
        vibration: 'Compensazione delle vibrazioni',
        motor_noise: 'Cancellazione del rumore dei motori',
        nozzle_offset: 'Offset ugello',
        high_temp_heatbed: 'Livellamento del piano ad alta temperatura',
        micro_lidar: 'Micro Lidar',
        nozzle_clumping: 'Rilevamento intasamento ugello',
      },
      ...
      triggerSchedule: 'Su pianificazione',
      triggerGatePlateClear: '(solo dopo che il piatto è stato liberato)',
      triggerGateIdle: '(non appena la stampante è libera)',
      scheduleDays: 'Giorni della settimana',
      scheduleTime: 'Non prima delle',
      reserveBeforeSchedule: 'Non avviare lavori che sconfinerebbero nell\'orario programmato',
      runNow: 'Esegui ora',
      cancelRun: 'Annulla esecuzione',
      runQueued: 'In coda – parte appena la stampante è libera',
      runningSince: 'Calibrazione in corso dalle {{time}}',
      nextRunAt: 'Prossima esecuzione: {{time}}',
      ...
      waitingAfterOtherRun: 'In attesa: dopo {{item}}',
      waitingOther: 'In attesa: {{reason}}',
      lastRunCompleted: 'Ultima esecuzione completata {{time}}',
      lastRunFailed: 'Ultima esecuzione fallita {{time}}: {{error}}',
      lastRunCancelled: 'Ultima esecuzione annullata {{time}}',
      runQueuedToast: 'Calibrazione in coda',
      runCancelledToast: 'Esecuzione della calibrazione annullata',
      runsCalibration: 'Esegue una calibrazione',
    },
  },
  ...
  settings: {
    ...
    // Linked spools (#2936)
    autoLinkScannedSpools: 'Collega automaticamente le bobine scansionate',
    autoLinkScannedSpoolsDesc: 'Quando una bobina scansionata o aggiunta automaticamente corrisponde a un prodotto esistente, la collega a quella bobina così da riceverla con tutti i dati del filamento — prezzo al kg incluso.',
    ...
    rfidAfterPrintDescription: "La stessa lettura dall'altro lato: quando una stampa finisce la stampante è libera, l'AMS può muovere il filamento e nessun lavoro attende la risposta. Viene eseguita dopo ogni stampa, completata o fallita. L'AMS può leggere solo se non c'è nulla di caricato — le stampanti di solito ritraggono il filamento alla fine — quindi una che ha ancora una bobina in un ugello viene lasciata alla stampa successiva. Si interrompe subito se parte una nuova stampa e lo spegnimento automatico attende che finisca.",
    rfidAfterPrintUnloadLabel: 'Scarica prima di leggere',
    rfidAfterPrintUnloadDescription: "Una stampante che alla fine della stampa ha ancora filamento caricato non può leggere alcun tag: l'AMS deve muovere il filamento per raggiungerlo. Con questa opzione il filamento viene prima ritratto nell'AMS e solo dopo viene eseguita la lettura. La stampante resta scarica; la stampa successiva carica ciò che le serve. A una stampante che ha già ritratto il filamento, il caso abituale, non viene mai inviato un comando di scarico.",
    ...
    suppliers: {
      title: 'Fornitori',
      description: 'Gestisci dove acquisti il filamento — distinto dalla marca, che indica chi lo ha prodotto. Assegna i fornitori alle bobine nella finestra della bobina; un fornitore ancora assegnato a delle bobine non può essere eliminato.',
      search: 'Cerca fornitori...',
      addNew: 'Aggiungi nuovo fornitore',
      namePlaceholder: 'Nome (es. Filament24)',
      websitePlaceholder: 'Sito web / URL del negozio',
      customerNumberPlaceholder: 'N. cliente',
      notePlaceholder: 'Nota',
      nameRequired: 'Il nome è obbligatorio',
      customerNumber: 'N. cliente',
      spools: 'Bobine',
      noMatch: 'Nessun fornitore corrisponde alla ricerca',
      empty: 'Nessun fornitore presente',
      added: 'Fornitore aggiunto',
      addFailed: 'Aggiunta del fornitore non riuscita',
      updated: 'Fornitore aggiornato',
      updateFailed: 'Aggiornamento del fornitore non riuscito',
      deleted: 'Fornitore eliminato',
      deleteFailed: 'Eliminazione del fornitore non riuscita',
      deleteBlocked: 'Impossibile eliminare: ancora assegnato a {{count}} bobina/e',
      loadFailed: 'Caricamento dei fornitori non riuscito',
      deleteTitle: 'Elimina fornitore',
      deleteConfirm: 'Eliminare "{{name}}"?',
      deleteConfirmReferenced: '"{{name}}" è assegnato a {{count}} bobina/e. L\'eliminazione è bloccata finché queste assegnazioni non vengono rimosse.',
    },
    catalog: {
    ...
    libraryRootView: 'Cosa mostra la radice',
    libraryRootViewAll: 'Tutti i file',
    libraryRootViewAllDescription: 'Ogni file della libreria in un unico elenco piatto.',
    libraryRootViewFolders: 'Solo cartelle',
    libraryRootViewFoldersDescription: 'Le cartelle di primo livello e una voce «Senza cartella» per i file che non stanno in nessuna.',
    libraryRootViewRecent: 'Aggiunti o modificati di recente',
    libraryRootViewRecentDescription: 'I file più recenti di tutta la libreria, al massimo 100 - una pagina iniziale, non un elenco.',
    libraryRootViewDescription: 'La ricerca e i filtri per tag riguardano sempre tutta la libreria, qualunque sia la scelta.',
    webdavMode: 'Accesso WebDAV',
    webdavDescription: 'Pubblica l’albero del gestore file via WebDAV, così una postazione può collegarlo come unità.',
    webdavModeOff: 'Disattivato',
    webdavModeOffDescription: 'L’indirizzo risponde 404, esattamente come in un’installazione che non ha mai avuto questa funzione.',
    webdavModeRead: 'Sola lettura',
    webdavModeReadDescription: 'I file si possono aprire e copiare; nulla di ciò che avviene sull’unità collegata modifica la libreria.',
    webdavModeReadWrite: 'Lettura e scrittura',
    webdavModeReadWriteDescription: 'Anche salvare, rinominare, spostare ed eliminare dall’unità, con gli stessi permessi di libreria che applica l’interfaccia web.',
    webdavAddressHint: 'Collega {{url}}. La condivisione contiene «Files» per la libreria gestita e, se sono registrate cartelle esterne, «External».',
    webdavCredentialsHint: 'Chiede sempre nome utente e password di Bambuddy — anche nelle installazioni la cui interfaccia web funziona senza login — e ogni utente vede solo i file che può leggere.',
    webdavTwoFactorHint: 'Un account con autenticazione a due fattori non può aprire la condivisione, perché l’autenticazione Basic non ha modo di chiedere il secondo codice, e le password sbagliate contano per lo stesso blocco del login web.',
    webdavHttpsHint: 'Pubblicalo via HTTPS, perché le credenziali Basic viaggiano a ogni singola richiesta.',
    webdavWindowsHint: 'Windows rifiuta l’autenticazione Basic su HTTP semplice finché HKLM\\SYSTEM\\CurrentControlSet\\Services\\WebClient\\Parameters\\BasicAuthLevel non vale 2. Su HTTPS funziona così com’è.',
    webdavWriteHint: 'Sovrascrivere mantiene la stessa voce della libreria, con i suoi tag e le sue note, e ne sostituisce solo il contenuto: nessuna versione e nessuna variante. Un’eliminazione manda il file nel cestino e una cartella creata dall’unità non riceve alcun numero.',
    libraryStorageMode: 'Archiviazione della libreria',
    libraryStorageDescription: 'Dove il gestore file conserva i suoi file: nell\'archivio proprio di Bambuddy o in un albero di directory che si limita a indicizzare.',
    libraryStorageModeManaged: 'Libreria propria di Bambuddy',
    libraryStorageModeManagedDescription: 'I file risiedono nella directory dei dati di Bambuddy e sono raggiungibili solo tramite Bambuddy. Nulla dall\'esterno può spostarli, quindi database e disco concordano sempre.',
    libraryStorageModeDirectory: 'Cartella su disco',
    libraryStorageModeDirectoryDescription: 'Una directory scelta da te — di solito una condivisione di rete — diventa la libreria stessa: ogni cartella è una directory reale, ogni file mantiene il nome reale e lo stesso albero si apre in Esplora file.',
    libraryStoragePath: 'Percorso della directory',
    libraryStoragePathHint: 'Percorso assoluto così come lo vede il server Bambuddy, quindi una condivisione va prima montata lì. Deve esistere, essere scrivibile e trovarsi fuori dalle directory dei dati di Bambuddy.',
    libraryStorageDriftHint: 'Tutto ciò che viene spostato o eliminato direttamente nella directory resta invisibile a Bambuddy finché la cartella non viene analizzata: analizzare diventa quindi abitudine e non un\'operazione una volta per tutte.',
    libraryStorageHashHint: 'I file trovati da un\'analisi non vengono sottoposti a hash — leggere ogni file di una condivisione costa una passata completa — e quindi non partecipano al riconoscimento dei duplicati. I file scritti tramite Bambuddy sì, come prima.',
    libraryStorageMigration: 'Spostare la libreria esistente nella directory',
    libraryStorageMigrationHint: 'Cambiare modalità non sposta nulla da sé. Qui ogni file viene copiato al suo posto nell\'albero, la copia viene verificata e solo dopo l\'originale viene rimosso. L\'operazione si può ripetere in qualsiasi momento e sposta ciò che resta.',
    libraryStoragePlanButton: 'Mostra cosa verrebbe spostato',
    libraryStorageMigrateButton: 'Sposta ora',
    libraryStoragePlanSummary: '{{files}} file, {{folders}} cartella/e, {{size}} da spostare.',
    libraryStorageMigrationDone: '{{files}} file spostati, {{folders}} directory create.',
    libraryStorageMigrationFailed: 'Non è stato possibile avviare la migrazione.',
    libraryStoragePathRequired: 'Indica prima il percorso.',
    ...
    libraryStorageScanDone: 'Scansione conclusa: {{added}} aggiunti, {{removed}} rimossi.',
    libraryStoragePlanFirst: 'Mostra prima cosa verrebbe spostato.',
    libraryStorageBlocked: 'Lo spostamento è bloccato da {{blockers}} collisione/i di nomi:',
    libraryStorageBlockerCollision: '{{first}} e {{second}} diventerebbero lo stesso file. Rinominane uno.',
    libraryStorageBlockerExists: '{{name}} esiste già lì. Spostalo o rinominalo sulla condivisione.',
    storageUsageLibraryTree: 'I file della libreria sono su {{path}}.',
    storageUsageLibraryTreeFree: '{{free}} liberi su {{total}}',
  ...
  fileManager: {
    ...
    renderingPreviews: 'Generazione anteprime… {{done}}/{{total}}',
    generateThumbnailsForMissing: 'Genera miniature per i file STL e PDF senza anteprima',
    gridView: 'Vista griglia',
    listView: 'Vista elenco',
    ...
    recentCrumb: 'Recenti',
    sortedByRecent: 'Ordinato per data di aggiunta o modifica',
    pathBar: {
      label: 'Posizione',
      showHidden: 'Mostra le cartelle nascoste',
      editPath: 'Modifica percorso',
      noSuchFolder: 'Questa cartella non esiste',
      siblings: 'Cartelle di questo livello',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        noBody: 'Questo messaggio non contiene testo.',
        rtfNote: 'Testo estratto dal contenuto RTF — formattazione semplificata.',
      },
    },
    details: {
    ...
    toast: {
      ...
      filePathCopied: 'Percorso del file copiato',
      ...
      previewsRendered: '{{count}} anteprima/e generata/e nel browser',
      thumbnailsGeneratedPartial: 'Generate {{succeeded}} miniature, {{failed}} fallite',
      noStlMissingThumbnails: 'Nessun file STL o PDF senza miniatura',
  ...
  inventory: {
    ...
    vatIncl: 'IVA inclusa',
    vatExcl: 'IVA esclusa',
    vatInclShort: 'IVA incl.',
    vatExclShort: 'escl.',
    vatConvertedIncl: '= {{value}} IVA inclusa',
    vatConvertedExcl: '= {{value}} IVA esclusa',
    ...
    suppliers: {
      ...
      noneLeft: 'Tutti i fornitori sono già assegnati',
      createNew: 'Crea "{{name}}"',
      createFailed: 'Creazione del fornitore non riuscita',
      purchaseSource: 'Acquistato qui',
      purchaseSourceHelp: 'Indica dove questa bobina è stata effettivamente acquistata; le altre voci sono fonti alternative.',
      articleNumberPlaceholder: 'Codice articolo del fornitore',
      pricePlaceholder: 'Prezzo offerto/kg',
      priceHelp: 'Prezzo offerto da questo fornitore, per confrontare le fonti — il costo al kg della bobina rimane la base di costo.',
      help: 'Dove si può acquistare questo prodotto. La voce evidenziata è quella in cui è stata acquistata questa bobina.',
      saveFailed: 'Salvataggio delle assegnazioni dei fornitori non riuscito',
    },
    // Linked spools sharing filament master data (#2936)
    linked: {
      column: 'Collegata',
      indicatorTooltip: 'Bobina collegata — i dati del filamento sono condivisi con il suo gruppo',
      linkTitle: 'Collega bobine',
      pickSourceHint: 'Scegli la bobina i cui dati del filamento devono prevalere. Marca, colore, pesi, temperature, prezzo e note vengono copiati sulle altre e da quel momento restano sincronizzati. Peso residuo, tag, posizioni e cronologia restano sempre per singola bobina.',
      searchPlaceholder: 'Cerca bobine…',
      noCandidates: 'Nessuna bobina tra cui scegliere',
      alreadyLinked: 'collegata',
      linkConfirm: 'Questo sovrascriverà i dati del filamento di {{count}} bobina/e.',
      linkAction: 'Collega',
      linkedToast: 'Collegate — {{count}} record aggiornato/i',
      linkFailed: 'Impossibile collegare le bobine',
      banner: 'Collegata con {{count}} altra/e bobina/e — le modifiche ai dati del filamento si applicano a tutte.',
      notLinked: 'Non collegata ad altre bobine.',
      linkWithExisting: 'Collega a una bobina esistente…',
      unlinkAction: 'Scollega',
      unlinkedToast: 'Bobina scollegata',
      unlinkFailed: 'Impossibile scollegare la bobina',
      propagateTitle: 'Applicare alle bobine collegate?',
      propagateConfirm: 'Questa modifica aggiorna anche i dati del filamento di {{count}} bobina/e collegata/e. Peso residuo, tag, posizioni e cronologia restano invariati.',
    },
  ...
  printModal: {
    ...
    askForOutcome: 'Chiedi l’esito',
    askForOutcomeTitle: 'Chiedi com’è venuta la stampa una volta completata',
  },
  ...
  confirmOutcome: {
    title: 'Com\'è venuta la tua stampa?',
    good: 'Buona',
    reject: 'Scarto',
    later: 'Chiedimelo più tardi',
    noPhoto: 'Nessuna foto finale disponibile',
    savedGood: 'Contrassegnata come pezzo buono',
    savedReject: 'Contrassegnata come scartata',
    saveFailed: 'Impossibile salvare il verdetto',
    rejectReason: 'Motivo dello scarto (opzionale)',
  ...
  // Virtual Printer
  paCalibration: {
    title: 'Calibrazione della dinamica di flusso',
    menuAction: 'Calibra la dinamica di flusso…',
    printer: 'Stampante',
    nozzle: 'Ugello',
    slot: 'Alloggiamento',
    currentK: 'K attuale',
    noProfileYet: 'Nessun profilo ancora',
    cost: 'Durata',
    costValue: 'circa {{minutes}} min, circa {{grams}} g',
    plateType: 'Piano di stampa sul letto',
    plateTypeHint: 'La linea viene elaborata per questo piano, quindi deve corrispondere a quello davvero montato.',
    presetsHint: 'Elaborato con questi preset. Scegli il profilo filamento giusto per una bobina di terze parti.',
    plateConfirm: 'Il piano è vuoto e la linea stampata può essere rimossa in seguito.',
    start: 'Avvia calibrazione',
    save: 'Salva sulla stampante',
    discard: 'Scarta',
    cancelPrintConfirm: 'Interrompere la stampa di calibrazione?',
    oldK: 'K memorizzato',
    newK: 'K misurato',
    nCoef: 'Coefficiente di flusso',
    confidence: 'Affidabilità',
    willOverwrite: 'Il salvataggio sostituisce il profilo K esistente.',
    willCreate: 'Il salvataggio crea un nuovo profilo K e lo assegna a questo alloggiamento.',
    notLoaded: 'Non caricato in nessun alloggiamento',
    noPermission: 'Non hai il permesso di avviare una stampa su questa stampante.',
    blocked: {
      model_not_supported: 'Non ancora supportato su questa stampante.',
      printer_offline: 'La stampante non è in linea.',
      printer_busy: 'La stampante sta stampando.',
      printer_reserved: 'La stampante è riservata da un altro lavoro.',
      run_already_active: 'Su questa stampante è già in corso una calibrazione.',
      slicer_not_configured: 'Il servizio di slicing non è raggiungibile. Questa calibrazione è una stampa elaborata e lo richiede.',
      slot_empty: 'L\'alloggiamento non contiene filamento identificato.',
      nozzle_unknown: 'La stampante non ha comunicato quale ugello è montato.',
      printer_preset_unavailable: 'Lo slicer non include un profilo per questa stampante e questo ugello.',
    },
    status: {
      queued: 'In attesa della stampante',
      slicing: 'Elaborazione',
      uploading: 'Caricamento',
      printing: 'In stampa',
      reading_result: 'Lettura del risultato',
      awaiting_confirmation: 'In attesa della tua decisione',
      saving: 'Salvataggio sulla stampante',
      done: 'Salvato',
      failed: 'Non riuscita',
      cancelled: 'Annullata',
    },
    waiting: {
      printer_offline: 'In attesa che la stampante torni in linea',
      printer_busy: 'In attesa che la stampante finisca il lavoro in corso',
      printer_reserved: 'In attesa che la coda liberi la stampante',
      plate_not_cleared: 'In attesa della conferma che il piano sia libero',
    },
    plates: {
      cool_plate: 'Piano freddo',
      eng_plate: 'Piano engineering',
      hot_plate: 'Piano PEI liscio',
      textured_plate: 'Piano PEI testurizzato',
    },
    preset: {
      printer: 'Preset stampante',
      process: 'Preset processo',
  ...
  // Model Viewer
  modelViewer: {
    stepConverting: 'Conversione del modello STEP… {{seconds}} s',
    stepSlowHint: 'I file STEP di grandi dimensioni possono richiedere un minuto o più.',
  ...
  notifications: {
    ...
    printConfirmRequest: 'Conferma esito',
    printConfirmRequestDescription: 'Chiedi un verdetto buona/scarto con link a un tocco quando si completa una stampa con l\'opzione attiva',
    ...
    maintenanceRun: 'Esecuzione di manutenzione terminata',
    maintenanceRunDescription: 'Notifica quando una calibrazione avviata da Bambuddy è completata, fallita o annullata',
    ...
    paCalibration: 'Calibrazione',
    paCalibrationTitle: 'Calibrazione della dinamica di flusso',
    paCalibrationDescription: 'Una misura di pressure advance è pronta e attende di essere salvata, oppure la sessione è finita',
    ...
    eventTypes: {
      ...
      maintenance_run: 'Esecuzione di manutenzione terminata',
      test: 'Prova',
    },
