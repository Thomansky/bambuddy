export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: 'フローダイナミクス校正の終了待ち',
  ...
  archives: {
    ...
    filterUnconfirmed: '未確認',
    filterUnconfirmedTitle: '結果の判定待ちの印刷のみを表示',
    ...
    card: {
      ...
      printerWear: 'プリンター摩耗',
      printerWearDetail: '{{hours}} 時間 × {{rate}} {{currency}}/時間',
  ...
  stats: {
    ...
    suppliers: {
      title: 'サプライヤー別',
      empty: 'まだ購入記録がありません。スプールにどのサプライヤーから購入したかを設定すると、ここに消費量とコストが集計されます。',
      supplier: 'サプライヤー',
      spools: 'スプール',
      remaining: '残量',
      consumed: '消費量',
    ...
    rejectedPrintsCount: '完了後に {{rejected}} 件が不良と判定',
    yieldRate: '歩留まり: {{rate}}%',
  ...
  maintenance: {
    ...
    section: {
      automatic: '自動で実行',
      automaticHint: '期限が来てプリンターが空いていれば、Bambuddy が自動で実行します。通知が届くだけです。',
      manual: '手動で実施',
      manualHint: 'リマインダーです。期限は Bambuddy が管理し、作業と完了の記録はご自身で行います。',
    },
    noItems: 'メンテナンスはまだ設定されていません',
    ...
    calibration: {
      option: {
        bed_leveling: 'ベッドレベリング',
        vibration: '振動補正',
        motor_noise: 'モーターノイズキャンセリング',
        nozzle_offset: 'ノズルオフセット',
        high_temp_heatbed: '高温ベッドレベリング',
      ...
      runningSince: '{{time}} からキャリブレーション実行中',
      nextRunAt: '次回実行: {{time}}',
      ...
      lastRunCancelled: '前回の実行キャンセル {{time}}',
      runQueuedToast: 'キャリブレーションを待機列に追加しました',
      runCancelledToast: 'キャリブレーションの実行をキャンセルしました',
      runsCalibration: 'キャリブレーションを実行',
    },
  },
  ...
  settings: {
    ...
    autoLinkScannedSpools: 'スキャンしたスプールを自動リンク',
    autoLinkScannedSpoolsDesc: 'スキャンまたは自動追加されたスプールが既存の製品と一致した場合、そのスプールにリンクし、kg単価を含む完全なフィラメントデータ付きで登録されます。',
    ...
    rfidRereadTitle: '未識別のAMSスプール',
    rfidRereadLabel: 'ジョブ開始前に未識別のAMSスプールを再読み取りする',
    rfidRereadDescription: 'プリンターが動作中に挿入されたスプールはAMSに識別されません。有効にすると、ジョブの割り当てと開始の前に、キューがAMSに対して使用中かつ未識別のスロットをすべて読み取るよう要求します。ジョブごとに1回だけ行われ、結果にかかわらずジョブは開始されます。',
    rfidAfterPrintLabel: '印刷後に未識別のAMSスプールを読み取る',
    rfidAfterPrintDescription: '同じ読み取りを反対側で行います。印刷が終わるとプリンターは空き、AMSはフィラメントを動かせて、どのジョブも結果を待っていません。完了・失敗を問わず毎回の印刷後に実行します。AMSは何も装填されていないときしか読み取れず（プリンターは終了時に通常フィラメントを戻します）、ノズルにスプールが残っているプリンターは次の印刷のあとに回します。新しい印刷が始まればただちに中断し、自動電源オフは読み取りの完了を待ちます。',
    rfidAfterPrintUnloadLabel: '読み取り前にアンロードする',
    rfidAfterPrintUnloadDescription: '印刷終了時にまだフィラメントが装填されているプリンターはタグを読み取れません。AMSはタグに届かせるためにフィラメントを動かす必要があるからです。この設定を有効にすると、先にフィラメントをAMSへ戻してから読み取りを行います。そのあとプリンターはアンロードされたままになります―次の印刷が必要なものを装填するからです。すでにフィラメントを戻しているプリンター（通常はこちら）にアンロード命令を送ることはありません。',
    ...
    suppliers: {
      title: 'サプライヤー',
      description: 'フィラメントの購入先を管理します。製造元であるブランドとは別の概念です。スプールダイアログでスプールにサプライヤーを割り当てられます。スプールに割り当てられているサプライヤーは削除できません。',
      search: 'サプライヤーを検索...',
      addNew: '新しいサプライヤーを追加',
      namePlaceholder: '名前（例：Filament24）',
      websitePlaceholder: 'ウェブサイト / ショップURL',
      customerNumberPlaceholder: '顧客番号',
      notePlaceholder: 'メモ',
      nameRequired: '名前は必須です',
      customerNumber: '顧客番号',
      spools: 'スプール',
      noMatch: '検索に一致するサプライヤーがありません',
      empty: 'サプライヤーはまだありません',
      added: 'サプライヤーを追加しました',
      addFailed: 'サプライヤーの追加に失敗しました',
      updated: 'サプライヤーを更新しました',
      updateFailed: 'サプライヤーの更新に失敗しました',
      deleted: 'サプライヤーを削除しました',
      deleteFailed: 'サプライヤーの削除に失敗しました',
      deleteBlocked: '削除できません：まだ{{count}}個のスプールに割り当てられています',
      loadFailed: 'サプライヤーの読み込みに失敗しました',
      deleteTitle: 'サプライヤーを削除',
      deleteConfirm: '「{{name}}」を削除しますか？',
      deleteConfirmReferenced: '「{{name}}」は{{count}}個のスプールに割り当てられています。割り当てを解除するまで削除できません。',
    },
    catalog: {
    ...
    vatEnabled: '税込・税抜の区別（消費税）',
    vatEnabledHelp: '業務用途向け：スプールコストに消費税の基準（税込／税抜）を追加し、請求書の金額をそのまま入力できるようにします。オフ（デフォルト）の場合は消費税に関する表示がすべて非表示になり、個人利用では何も変わりません。',
    vatRate: '消費税率（%）',
    vatRateHelp: '表示や在庫価値のために、スプールコストを税込価格と税抜価格の間で換算する際に使用されます。0に設定すると消費税のヒントは表示されません。',
    priceBasis: '価格基準',
    ...
    libraryRootView: 'ルートに表示する内容',
    libraryRootViewAll: 'すべてのファイル',
    libraryRootViewAllDescription: 'ライブラリのすべてのファイルを一つのフラットな一覧で表示します。',
    libraryRootViewFolders: 'フォルダのみ',
    libraryRootViewFoldersDescription: '最上位のフォルダと、どのフォルダにも属さないファイル用の「フォルダなし」項目を表示します。',
    libraryRootViewRecent: '最近追加または変更されたもの',
    libraryRootViewRecentDescription: 'ライブラリ全体で最も新しいファイルを最大100件。一覧ではなくスタートページです。',
    libraryRootViewDescription: '検索とタグフィルターは、どれを選んでも常にライブラリ全体を対象にします。',
    webdavMode: 'WebDAV アクセス',
    webdavDescription: 'ファイルマネージャーのツリーを WebDAV で公開し、ワークステーションからドライブとして割り当てられるようにします。',
    webdavModeOff: 'オフ',
    webdavModeOffDescription: 'アドレスは 404 を返します。この機能がなかった環境とまったく同じ挙動です。',
    webdavModeRead: '読み取り専用',
    webdavModeReadDescription: 'ファイルを開いてコピーできます。割り当てたドライブ上の操作がライブラリを変えることはありません。',
    webdavModeReadWrite: '読み書き',
    webdavModeReadWriteDescription: 'ドライブからの保存・名前の変更・移動・削除もできます。Web 画面と同じライブラリ権限が適用されます。',
    ...
    webdavHttpsHint: 'Basic 認証の資格情報はすべてのリクエストに付いて送られるため、HTTPS で公開してください。',
    ...
    webdavWriteHint: '上書き保存はライブラリの同じ項目をそのまま使い、タグやメモを保ったまま内容だけを置き換えます。バージョンもバリアントも作りません。削除したファイルはゴミ箱に移り、ドライブから作ったフォルダーには番号が付きません。',
    libraryStorageMode: 'ライブラリの保存先',
    libraryStorageDescription: 'ファイルマネージャーがファイルを置く場所です。Bambuddy 独自の保存領域か、索引だけを作るディレクトリツリーのどちらかです。',
    libraryStorageModeManaged: 'Bambuddy 独自のライブラリ',
    libraryStorageModeManagedDescription: 'ファイルは Bambuddy のデータディレクトリにあり、Bambuddy 経由でしか扱えません。外部から動かされないため、データベースとディスクの内容が常に一致します。',
    libraryStorageModeDirectory: 'ディレクトリ',
    libraryStorageModeDirectoryDescription: '選んだディレクトリ（多くはネットワーク共有）がそのままライブラリになります。フォルダーは実際のディレクトリ、ファイルは本来の名前のままで、同じツリーをエクスプローラーで開けます。',
    libraryStoragePath: 'ディレクトリのパス',
    libraryStoragePathHint: 'Bambuddy サーバーから見た絶対パスです。共有はあらかじめそこにマウントしておく必要があります。存在し、書き込みでき、Bambuddy のデータディレクトリの外にあることが条件です。',
    libraryStorageDriftHint: 'ディレクトリ側で直接移動・削除したものは、フォルダーをスキャンするまで Bambuddy には見えません。スキャンは一度きりの作業ではなく日常の一部になります。',
    libraryStorageHashHint: 'スキャンで見つかったファイルはハッシュを取りません（共有の全ファイルを読むには一巡分の負荷がかかります）。そのため重複検出には加わりません。Bambuddy 経由で書き込まれたファイルは従来どおりハッシュされます。',
    libraryStorageMigration: '既存のライブラリをディレクトリへ移す',
    libraryStorageMigrationHint: 'モードの切り替えだけでは何も移動しません。ここでは各ファイルをツリー内の所定の位置へコピーし、コピーを検証したうえで元のファイルを削除します。いつでも再実行でき、残っている分を移します。',
    libraryStoragePlanButton: '移動する内容を表示',
    libraryStorageMigrateButton: '今すぐ移す',
    libraryStoragePlanSummary: 'ファイル {{files}} 件、フォルダー {{folders}} 件、{{size}} を移動します。',
    libraryStorageMigrationDone: 'ファイル {{files}} 件を移動し、ディレクトリ {{folders}} 件を作成しました。',
    ...
    libraryStorageScanDone: 'スキャン完了: {{added}} 件追加、{{removed}} 件削除。',
    ...
    libraryStorageBlockerExists: '{{name}} はすでにそこにあります。共有側で移動するか名前を変えてください。',
    storageUsageLibraryTree: 'ライブラリのファイルは {{path}} にあります。',
    storageUsageLibraryTreeFree: '{{total}} 中 {{free}} 空き',
    // Updates
  ...
  fileManager: {
    ...
    renderingPreviews: 'プレビューを生成中… {{done}}/{{total}}',
    ...
    noFolder: 'フォルダなし',
    recentCrumb: '最近',
    sortedByRecent: '追加日または変更日で並べ替え',
    pathBar: {
      label: '場所',
      showHidden: '省略されたフォルダを表示',
      editPath: 'パスを編集',
      noSuchFolder: 'そのフォルダはありません',
      siblings: 'この階層のフォルダ',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        date: '日付',
        attachments: '添付ファイル',
        noBody: 'このメッセージには本文がありません。',
        rtfNote: 'リッチテキストコンテンツから抽出したテキストです。書式は簡略化されています。',
      },
    },
    details: {
      title: 'ファイルの詳細',
    ...
    toast: {
      ...
      previewsRendered: 'ブラウザーで {{count}} 件のプレビューを生成しました',
  ...
  inventory: {
    ...
    vatInclShort: '税込',
    vatExclShort: '税抜',
    vatConvertedIncl: '= {{value}}（税込）',
    vatConvertedExcl: '= {{value}}（税抜）',
    ...
    suppliers: {
      ...
      noneLeft: 'すべてのサプライヤーが割り当て済みです',
      createNew: '「{{name}}」を作成',
      createFailed: 'サプライヤーの作成に失敗しました',
      purchaseSource: 'ここで購入',
      purchaseSourceHelp: 'このスプールを実際に購入した場所を示します。その他の項目は代替の購入先です。',
      articleNumberPlaceholder: 'サプライヤーの品番',
      pricePlaceholder: '提示価格/kg',
      priceHelp: 'このサプライヤーでの提示価格です。購入先の比較用であり、スプール自体のkg単価が原価の基準のままです。',
      help: 'この製品の購入先です。ハイライトされた項目がこのスプールを購入した場所です。',
      saveFailed: 'サプライヤーの割り当ての保存に失敗しました',
    },
    linked: {
      column: 'リンク',
      indicatorTooltip: 'リンク済みスプール — フィラメントデータはグループ内で共有されます',
      linkTitle: 'スプールをリンク',
      pickSourceHint: 'フィラメントデータの基準となるスプールを選択してください。そのブランド、色、重量、温度、価格、メモが他のスプールにコピーされ、以降は同期されます。残量、タグ、保管場所、履歴は常にスプールごとに保持されます。',
      searchPlaceholder: 'スプールを検索…',
      noCandidates: '選択できるスプールがありません',
      alreadyLinked: 'リンク済み',
      linkConfirm: '{{count}} 件のスプールのフィラメントデータが上書きされます。',
      linkAction: 'リンク',
      linkedToast: 'リンクしました — {{count}} 件のレコードを更新しました',
      linkFailed: 'スプールのリンクに失敗しました',
      banner: '他の {{count}} 件のスプールとリンクしています — フィラメントデータの変更はすべてに適用されます。',
      notLinked: '他のスプールとリンクしていません。',
      linkWithExisting: '既存のスプールとリンク…',
      unlinkAction: 'リンク解除',
      unlinkedToast: 'スプールのリンクを解除しました',
      unlinkFailed: 'スプールのリンク解除に失敗しました',
      propagateTitle: 'リンク済みスプールにも適用しますか？',
      propagateConfirm: 'この変更は、リンクされた {{count}} 件のスプールのフィラメントデータも更新します。残量、タグ、保管場所、履歴は変更されません。',
    },
  ...
  confirmOutcome: {
    title: '印刷の仕上がりはいかがでしたか？',
    good: '良品',
    reject: '不良',
    later: '後で確認',
    noPhoto: '完成写真がありません',
    savedGood: '良品として記録しました',
    savedReject: '不良として記録しました',
    saveFailed: '判定を保存できませんでした',
    rejectReason: '不良理由（任意）',
    noReason: '理由なし',
    saveReject: '保存',
  ...
  paCalibration: {
    title: 'フローダイナミクス調整',
    menuAction: 'フローダイナミクスを調整…',
    printer: 'プリンター',
    nozzle: 'ノズル',
    slot: 'スロット',
    currentK: '現在のK値',
    noProfileYet: 'プロファイルなし',
    cost: '所要時間',
    costValue: '約 {{minutes}} 分、約 {{grams}} g',
    plateType: 'ベッドに載っているプレート',
    plateTypeHint: 'ラインはこのプレート向けにスライスされるため、実際に載っているものと一致させてください。',
    presetsHint: 'これらのプリセットでスライスします。他社製フィラメントでは対応するプロファイルを選んでください。',
    plateConfirm: 'プレートは空で、印刷されたラインは後で取り除いて構いません。',
    start: '調整を開始',
    save: 'プリンターに保存',
    discard: '破棄',
    cancelPrintConfirm: '調整用の印刷を停止しますか？',
    oldK: '保存済みK値',
    newK: '測定されたK値',
    nCoef: '流量係数',
    confidence: '信頼度',
    willOverwrite: '保存すると既存のKプロファイルを置き換えます。',
    willCreate: '保存すると新しいKプロファイルを作成し、このスロットに割り当てます。',
    notLoaded: 'どのスロットにも装填されていません',
    noPermission: 'このプリンターで印刷を開始する権限がありません。',
    blocked: {
      model_not_supported: 'このプリンターではまだ対応していません。',
      printer_offline: 'プリンターがオフラインです。',
      printer_busy: 'プリンターは印刷中です。',
      printer_reserved: 'プリンターは別のジョブに確保されています。',
      run_already_active: 'このプリンターでは既に調整が実行中です。',
      slicer_not_configured: 'スライサーサービスに接続できません。この調整はスライス済みの印刷なので必須です。',
      slot_empty: 'スロットに識別済みのフィラメントがありません。',
      nozzle_unknown: '装着されているノズルがプリンターから報告されていません。',
      printer_preset_unavailable: 'このプリンターとノズル向けの同梱プロファイルがスライサーにありません。',
    },
    status: {
      queued: 'プリンターを待機中',
      slicing: 'スライス中',
      uploading: 'アップロード中',
      printing: '印刷中',
      reading_result: '結果を読み取り中',
      awaiting_confirmation: '判断を待っています',
      saving: 'プリンターに保存中',
      done: '保存しました',
      failed: '失敗しました',
      cancelled: 'キャンセルしました',
    ...
    waiting: {
      printer_offline: 'プリンターがオンラインに戻るのを待っています',
      printer_busy: 'プリンターが現在のジョブを終えるのを待っています',
      printer_reserved: 'キューがプリンターを解放するのを待っています',
      plate_not_cleared: 'プレートが空であることの確認を待っています',
    },
    plates: {
      cool_plate: 'クールプレート',
      eng_plate: 'エンジニアリングプレート',
      hot_plate: 'スムースPEIプレート',
      textured_plate: 'テクスチャPEIプレート',
    },
    preset: {
      printer: 'プリンタープリセット',
      process: 'プロセスプリセット',
      filament: 'フィラメントプリセット',
    },
  },
  virtualPrinter: {
    title: '仮想プリンター',
  ...
  notifications: {
    ...
    printConfirmRequest: '結果確認',
    printConfirmRequestDescription: '確認を有効にした印刷の完了時に、ワンタップリンクで良品/不良の判定を求める',
    plateClear: 'プレート確認',
    printCompleted: '印刷完了',
    ...
    paCalibration: 'キャリブレーション',
    paCalibrationTitle: 'フローダイナミクス調整',
    paCalibrationDescription: 'プレッシャーアドバンスの測定が終わり保存待ちになった、または実行が終了しました',
