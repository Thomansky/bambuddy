export default {
  ...
  settings: {
    ...
    rfidAfterPrintDescription: '同じ読み取りを反対側で行います。印刷が終わるとプリンターは空き、AMSはフィラメントを動かせて、どのジョブも結果を待っていません。完了・失敗を問わず毎回の印刷後に実行し、ノズルに装填されたままのスプールは飛ばし、新しい印刷が始まればただちに中断します。自動電源オフは読み取りの完了を待ちます。',
