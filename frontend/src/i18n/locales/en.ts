export default {
  ...
  printers: {
    ...
    modal: {
      ...
      expectedLifetimeHours: 'Expected lifetime (hours)',
      depreciationHelp: 'Charges printer wear per printing hour to future prints. Leave both empty to disable.',
      depreciationRate: '≈ {{rate}} {{currency}}/h printer wear',
