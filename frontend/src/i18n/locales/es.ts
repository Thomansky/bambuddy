export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: 'Esperando a que termine una calibración de dinámica de flujo',
  ...
  archives: {
    ...
    filterUnconfirmedTitle: 'Mostrar solo las impresiones que aún esperan su veredicto de resultado',
    ...
    card: {
      ...
      printerWear: 'Desgaste de la impresora',
      printerWearDetail: '{{hours}} h × {{rate}} {{currency}} por hora',
    ...
    log: {
      ...
      depreciationCost: 'Desgaste de impresora',
      completedAt: 'Finalizado',
      jobNumber: 'N.º trabajo',
      columns: 'Columnas',
  ...
  stats: {
    ...
    suppliers: {
      title: 'Por proveedor',
      empty: 'Aún no hay compras registradas. Marque en una bobina a qué proveedor se compró para agrupar aquí el consumo y los costes.',
      supplier: 'Proveedor',
      spools: 'Bobinas',
      remaining: 'Restante',
      consumed: 'Consumido',
    ...
    rejectedPrintsCount: '{{rejected}} rechazadas tras completarse',
    yieldRate: 'Rendimiento: {{rate}}%',
  ...
  maintenance: {
    ...
    types: {
      ...
      printerCalibration: 'Calibración de la impresora',
      visionEncoderCalibration: 'Calibración del codificador de visión',
    },
    // Toast
    ...
    section: {
      automatic: 'Se ejecuta sola',
      automaticHint: 'Bambuddy las inicia en la impresora cuando toca y está libre; solo se te avisa.',
      manual: 'La haces tú',
      manualHint: 'Un recordatorio. Bambuddy controla el vencimiento; el trabajo y la confirmación son tuyos.',
    },
    noItems: 'Aún no hay mantenimientos configurados',
    ...
    calibration: {
      option: {
        bed_leveling: 'Nivelación de la cama',
        vibration: 'Compensación de vibraciones',
        motor_noise: 'Cancelación del ruido del motor',
        nozzle_offset: 'Desfase de boquilla',
        high_temp_heatbed: 'Nivelación de cama a alta temperatura',
        micro_lidar: 'Micro Lidar',
        nozzle_clumping: 'Detección de obstrucción de boquilla',
      },
      ...
      triggerSchedule: 'Según programación',
      triggerGatePlateClear: '(solo cuando se haya liberado la placa)',
      ...
      runningSince: 'Calibración en curso desde {{time}}',
      nextRunAt: 'Próxima ejecución: {{time}}',
      ...
      lastRunCancelled: 'Última ejecución cancelada {{time}}',
      runQueuedToast: 'Calibración en cola',
      runCancelledToast: 'Ejecución de calibración cancelada',
      runsCalibration: 'Ejecuta una calibración',
    },
  },
  ...
  settings: {
    ...
    // Linked spools (#2936)
    autoLinkScannedSpools: 'Vincular automáticamente las bobinas escaneadas',
    autoLinkScannedSpoolsDesc: 'Cuando una bobina escaneada o añadida automáticamente coincide con un producto existente, se vincula a esa bobina para que llegue con todos los datos del filamento — incluido el precio por kg.',
    ...
    confirmDefaultGoodOnPlateClearDescription: 'Cuando se despeja la cama (manualmente o por la siguiente impresión en cola) y la pregunta sobre el resultado de la impresión sigue sin responder, registrarla automáticamente como pieza buena. La impresión cuenta entonces como buena en cuanto se despeja la cama; una respuesta posterior por Telegram o por enlace solo muestra el resultado ya registrado.',
    ...
    rfidAfterPrintLabel: 'Leer las bobinas AMS sin identificar después de imprimir',
    rfidAfterPrintDescription: 'La misma lectura en el otro extremo: cuando termina una impresión la impresora está libre, el AMS puede mover filamento y ningún trabajo espera la respuesta. Se ejecuta después de cada impresión, tanto si terminó como si falló. El AMS solo puede leer si no hay nada cargado —las impresoras suelen retraer el filamento al terminar—, así que una que aún tenga una bobina en el extrusor se deja para después de la siguiente impresión. Se detiene de inmediato si comienza una impresión nueva y el apagado automático espera a que termine.',
    rfidAfterPrintUnloadLabel: 'Descargar antes de leer',
    rfidAfterPrintUnloadDescription: 'Una impresora que aún tiene filamento cargado al terminar la impresión no puede leer ninguna etiqueta: el AMS necesita mover filamento para alcanzarla. Con esto activado, el filamento se retrae primero al AMS y después se realiza la lectura. La impresora queda descargada; la siguiente impresión cargará lo que necesite. A una impresora que ya ha retraído el filamento, que es el caso habitual, nunca se le envía una orden de descarga.',
    ...
    suppliers: {
      title: 'Proveedores',
      description: 'Gestione dónde compra el filamento, algo distinto de la marca, que indica quién lo fabricó. Asigne proveedores a las bobinas en el diálogo de bobina; un proveedor que siga asignado a bobinas no se puede eliminar.',
      search: 'Buscar proveedores...',
      addNew: 'Añadir nuevo proveedor',
      namePlaceholder: 'Nombre (p. ej. Filament24)',
      websitePlaceholder: 'Sitio web / URL de la tienda',
      customerNumberPlaceholder: 'N.º de cliente',
      notePlaceholder: 'Nota',
      nameRequired: 'El nombre es obligatorio',
      customerNumber: 'N.º de cliente',
      spools: 'Bobinas',
      noMatch: 'Ningún proveedor coincide con su búsqueda',
      empty: 'Aún no hay proveedores',
      added: 'Proveedor añadido',
      addFailed: 'Error al añadir el proveedor',
      ...
      deleteBlocked: 'No se puede eliminar: sigue asignado a {{count}} bobina(s)',
      loadFailed: 'Error al cargar los proveedores',
      deleteTitle: 'Eliminar proveedor',
      deleteConfirm: '¿Eliminar "{{name}}"?',
      deleteConfirmReferenced: '"{{name}}" está asignado a {{count}} bobina(s). La eliminación está bloqueada hasta que se quiten esas asignaciones.',
    },
    catalog: {
    ...
    libraryRootView: 'Qué muestra la raíz',
    libraryRootViewAll: 'Todos los archivos',
    libraryRootViewAllDescription: 'Todos los archivos de la biblioteca en una única lista plana.',
    libraryRootViewFolders: 'Solo carpetas',
    libraryRootViewFoldersDescription: 'Las carpetas de primer nivel y una entrada «Sin carpeta» para los archivos que no están en ninguna.',
    ...
    webdavMode: 'Acceso WebDAV',
    webdavDescription: 'Publica el árbol del gestor de archivos por WebDAV para que un equipo pueda conectarlo como unidad.',
    webdavModeOff: 'Desactivado',
    webdavModeOffDescription: 'La dirección responde 404, igual que en una instalación que nunca tuvo la función.',
    webdavModeRead: 'Solo lectura',
    webdavModeReadDescription: 'Los archivos se pueden abrir y copiar; nada de lo que se haga en la unidad conectada cambia la biblioteca.',
    webdavModeReadWrite: 'Lectura y escritura',
    webdavModeReadWriteDescription: 'También guardar, renombrar, mover y borrar desde la unidad, con los mismos permisos de biblioteca que aplica la interfaz web.',
    ...
    webdavHttpsHint: 'Publícalo por HTTPS, porque las credenciales Basic viajan en cada una de las peticiones.',
    ...
    webdavWriteHint: 'Al sobrescribir se conserva la misma entrada de la biblioteca, con sus etiquetas y notas, y solo se reemplaza el contenido: ni versión ni variante. Al borrar, el archivo va a la papelera, y una carpeta creada desde la unidad no recibe número.',
    libraryStorageMode: 'Almacenamiento de la biblioteca',
    libraryStorageDescription: 'Dónde guarda el gestor de archivos sus archivos: en el almacén propio de Bambuddy o en un árbol de directorios que solo indexa.',
    libraryStorageModeManaged: 'Biblioteca propia de Bambuddy',
    libraryStorageModeManagedDescription: 'Los archivos viven en el directorio de datos de Bambuddy y solo se alcanzan a través de él. Nada externo puede moverlos, así que la base de datos y el disco siempre coinciden.',
    libraryStorageModeDirectory: 'Directorio',
    libraryStorageModeDirectoryDescription: 'Un directorio que elijas — normalmente un recurso compartido de red — se convierte en la biblioteca: cada carpeta es un directorio real, cada archivo conserva su nombre real y el mismo árbol se abre en el explorador.',
    libraryStoragePath: 'Ruta del directorio',
    libraryStoragePathHint: 'Ruta absoluta tal como la ve el servidor de Bambuddy, por lo que un recurso compartido debe estar montado allí primero. Debe existir, permitir escritura y quedar fuera de los directorios de datos de Bambuddy.',
    libraryStorageDriftHint: 'Todo lo que se mueva o borre directamente en el directorio es invisible para Bambuddy hasta que se analice la carpeta, así que analizar pasa a ser parte de la rutina y no algo puntual.',
    libraryStorageHashHint: 'Los archivos que encuentra un análisis no se resumen con hash — leer cada archivo de un recurso compartido cuesta una pasada completa — y por eso no participan en la detección de duplicados. Los archivos escritos a través de Bambuddy sí, como antes.',
    libraryStorageMigration: 'Trasladar la biblioteca existente al directorio',
    libraryStorageMigrationHint: 'Cambiar el modo no mueve nada por sí solo. Esto copia cada archivo a su sitio en el árbol, comprueba la copia y solo entonces elimina el original. Puede ejecutarse de nuevo en cualquier momento y moverá lo que quede.',
    libraryStoragePlanButton: 'Mostrar qué se movería',
    libraryStorageMigrateButton: 'Mover ahora',
    libraryStoragePlanSummary: '{{files}} archivo(s), {{folders}} carpeta(s), {{size}} por mover.',
    libraryStorageMigrationDone: '{{files}} archivo(s) movido(s), {{folders}} directorio(s) creado(s).',
    libraryStorageMigrationFailed: 'No se pudo iniciar la migración.',
    libraryStoragePathRequired: 'Indica primero la ruta.',
    libraryStorageUnsaved: 'Aún sin guardar',
    libraryStorageSaved: 'Guardado',
    libraryAutoscan: 'Mantener al día con el directorio',
    libraryScanOnOpen: 'Actualizar una carpeta al abrirla',
    libraryScanOnOpenHint: 'Cada vez que se abre una carpeta en el gestor de archivos, se compara con el directorio. No cuesta nada mientras nadie usa Bambuddy.',
    libraryAutoscanHint: 'Lo que se mueve o borra directamente en el directorio solo llega a Bambuddy mediante un análisis. Aquí defines con qué frecuencia ocurre solo — 0 lo desactiva y lo deja al botón.',
    libraryAutoscanUnit: 'minutos (0 = desactivado)',
    libraryStorageScanButton: 'Analizar ahora',
    libraryStorageScanDone: 'Análisis terminado: {{added}} añadidos, {{removed}} retirados.',
    libraryStoragePlanFirst: 'Muestra primero qué se movería.',
    libraryStorageBlocked: 'El traslado está bloqueado por {{blockers}} colisión(es) de nombres:',
    libraryStorageBlockerCollision: '{{first}} y {{second}} acabarían siendo el mismo archivo. Renombra uno.',
    libraryStorageBlockerExists: '{{name}} ya existe ahí. Muévelo o renómbralo en el recurso compartido.',
    storageUsageLibraryTree: 'Los archivos de la biblioteca están en {{path}}.',
    storageUsageLibraryTreeFree: '{{free}} libres de {{total}}',
    // Updates
    ...
    numberSeries: {
      ...
      padding: 'Dígitos',
      preview: 'siguiente: {{value}}',
      lowerHint: 'Si reduces el siguiente número, puede volver a asignarse uno que ya se ha usado.',
      loadError: 'No se pudieron cargar las series de numeración.',
      saveError: 'No se pudo guardar la serie de numeración.',
    },
    pipelineLimits: {
  ...
  fileManager: {
    ...
    renderingPreviews: 'Generando vistas previas… {{done}}/{{total}}',
    generateThumbnailsForMissing: 'Generar miniaturas para los archivos STL y PDF sin vista previa',
    gridView: 'Vista de cuadrícula',
    listView: 'Vista de lista',
    ...
    folderTilesToggle: {
      label: 'Carpetas en el área de contenido',
      hide: 'Ocultar las carpetas sobre los archivos',
      show: 'Mostrar las carpetas sobre los archivos',
    },
    sidebarToggle: {
    ...
    recentCrumb: 'Recientes',
    sortedByRecent: 'Ordenado por fecha de adición o modificación',
    pathBar: {
      label: 'Ubicación',
      showHidden: 'Mostrar carpetas ocultas',
      editPath: 'Editar ruta',
      noSuchFolder: 'No existe esa carpeta',
      siblings: 'Carpetas de este nivel',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        noBody: 'Este mensaje no tiene cuerpo de texto.',
        rtfNote: 'Texto extraído del contenido de texto enriquecido; el formato se ha simplificado.',
      },
    },
    details: {
    ...
    toast: {
      ...
      previewsRendered: '{{count}} vista(s) previa(s) generada(s) en el navegador',
  ...
  projects: {
    ...
    number: 'Número',
    numberPlaceholder: 'Se asigna automáticamente',
    numberTaken: 'Ese número ya lo usa otro proyecto.',
    description: 'Descripción',
  ...
  inventory: {
    ...
    vatBasis: 'Base de IVA',
    vatIncl: 'con IVA',
    vatExcl: 'sin IVA',
    vatInclShort: 'con IVA',
    vatExclShort: 'sin IVA',
    vatConvertedIncl: '= {{value}} con IVA',
    vatConvertedExcl: '= {{value}} sin IVA',
    ...
    materialNumberNext: 'Siguiente libre',
    materialNumberNextHint: 'Tomar el siguiente número de la serie de números de material — para un producto que aún no tiene.',
    materialNumberNextFailed: 'No se pudo asignar un número de material.',
    ...
    suppliers: {
      ...
      noneLeft: 'Todos los proveedores ya están asignados',
      createNew: 'Crear "{{name}}"',
      createFailed: 'Error al crear el proveedor',
      purchaseSource: 'Comprado aquí',
      purchaseSourceHelp: 'Indica dónde se compró realmente esta bobina; las demás entradas son fuentes alternativas.',
      articleNumberPlaceholder: 'N.º de artículo del proveedor',
      pricePlaceholder: 'Precio ofertado/kg',
      priceHelp: 'Precio ofertado por este proveedor, para comparar fuentes; el coste por kg de la propia bobina sigue siendo la base de coste.',
      help: 'Dónde se puede comprar este producto. La entrada resaltada es donde se compró esta bobina.',
      saveFailed: 'Error al guardar las asignaciones de proveedores',
    },
    // Linked spools sharing filament master data (#2936)
    linked: {
      column: 'Vinculada',
      indicatorTooltip: 'Bobina vinculada — los datos del filamento se comparten con su grupo',
      linkTitle: 'Vincular bobinas',
      pickSourceHint: 'Elija la bobina cuyos datos de filamento deben prevalecer. Su marca, color, pesos, temperaturas, precio y notas se copian a las demás y se mantienen sincronizados a partir de entonces. El peso restante, las etiquetas, las ubicaciones y el historial siempre se conservan por bobina.',
      searchPlaceholder: 'Buscar bobinas…',
      noCandidates: 'No hay bobinas para elegir',
      alreadyLinked: 'vinculada',
      linkConfirm: 'Esto sobrescribirá los datos de filamento de {{count}} bobina(s).',
      linkAction: 'Vincular',
      linkedToast: 'Vinculado — {{count}} registro(s) actualizado(s)',
      linkFailed: 'Error al vincular las bobinas',
      banner: 'Vinculada con {{count}} bobina(s) más — los cambios en los datos del filamento se aplican a todas ellas.',
      notLinked: 'No está vinculada a otras bobinas.',
      linkWithExisting: 'Vincular con una bobina existente…',
      unlinkAction: 'Desvincular',
      unlinkedToast: 'Bobina desvinculada',
      unlinkFailed: 'Error al desvincular la bobina',
      propagateTitle: '¿Aplicar a las bobinas vinculadas?',
      propagateConfirm: 'Este cambio también actualiza los datos de filamento de {{count}} bobina(s) vinculada(s). El peso restante, las etiquetas, las ubicaciones y el historial no se modifican.',
    },
    // RFID button rename
  ...
  confirmOutcome: {
    title: '¿Cómo ha salido su impresión?',
    good: 'Buena',
    reject: 'Rechazar',
    later: 'Preguntar más tarde',
    noPhoto: 'No hay foto del acabado disponible',
    savedGood: 'Marcada como pieza buena',
    savedReject: 'Marcada como rechazada',
    saveFailed: 'No se pudo guardar el veredicto',
    ...
    sources: {
      dialog: 'Registrado en la aplicación.',
      link: 'Registrado con un enlace de un toque.',
      plateClear: 'Registrado al despejar la cama.',
      printerCard: 'Registrado desde la tarjeta de la impresora.',
      api: 'Registrado a través de la API.',
      reaction: 'Registrado con una reacción en el chat.',
    },
  },
  ...
  editArchive: {
    ...
    status: 'Estado',
    userVerdict: 'Veredicto del resultado',
    verdicts: {
      none: 'Sin establecer',
      good: 'Pieza buena',
      reject: 'Rechazada',
  ...
  // Virtual Printer
  paCalibration: {
    title: 'Calibración de dinámica de flujo',
    menuAction: 'Calibrar dinámica de flujo…',
    printer: 'Impresora',
    nozzle: 'Boquilla',
    slot: 'Ranura',
    currentK: 'K actual',
    noProfileYet: 'Aún sin perfil',
    cost: 'Duración',
    costValue: 'unos {{minutes}} min, unos {{grams}} g',
    plateType: 'Placa de impresión en la cama',
    plateTypeHint: 'La línea se lamina para esta placa, así que debe coincidir con la que realmente está puesta.',
    presetsHint: 'Se lamina con estos ajustes. Elige el perfil de filamento adecuado para una bobina de terceros.',
    plateConfirm: 'La placa está vacía y la línea impresa puede retirarse después.',
    start: 'Iniciar calibración',
    save: 'Guardar en la impresora',
    discard: 'Descartar',
    cancelPrintConfirm: '¿Detener la impresión de calibración?',
    oldK: 'K guardada',
    newK: 'K medida',
    nCoef: 'Coeficiente de flujo',
    confidence: 'Confianza',
    willOverwrite: 'Al guardar se reemplaza el perfil K existente.',
    willCreate: 'Al guardar se crea un perfil K nuevo y se asigna a esta ranura.',
    notLoaded: 'No cargado en ninguna ranura',
    noPermission: 'No tiene permiso para iniciar una impresión en esta impresora.',
    blocked: {
      model_not_supported: 'Todavía no compatible con esta impresora.',
      printer_offline: 'La impresora está desconectada.',
      printer_busy: 'La impresora está imprimiendo.',
      printer_reserved: 'La impresora está reservada por otro trabajo.',
      run_already_active: 'Ya hay una calibración en curso en esta impresora.',
      slicer_not_configured: 'El servicio del laminador no responde. Esta calibración es una impresión laminada y lo necesita.',
      slot_empty: 'La ranura no contiene filamento identificado.',
      nozzle_unknown: 'La impresora no ha informado qué boquilla está montada.',
      printer_preset_unavailable: 'El laminador no trae ningún perfil para esta impresora y boquilla.',
    },
    status: {
      queued: 'Esperando a la impresora',
      slicing: 'Laminando',
      uploading: 'Subiendo',
      printing: 'Imprimiendo',
      reading_result: 'Leyendo el resultado',
      awaiting_confirmation: 'Esperando tu decisión',
      saving: 'Guardando en la impresora',
      done: 'Guardada',
      failed: 'Fallida',
      cancelled: 'Cancelada',
    },
    waiting: {
      printer_offline: 'Esperando a que la impresora vuelva a conectarse',
      printer_busy: 'Esperando a que la impresora termine su trabajo actual',
      printer_reserved: 'Esperando a que la cola libere la impresora',
      plate_not_cleared: 'Esperando la confirmación de que la placa está vacía',
    },
    plates: {
      cool_plate: 'Placa fría',
      eng_plate: 'Placa de ingeniería',
      hot_plate: 'Placa PEI lisa',
      textured_plate: 'Placa PEI texturizada',
    },
    preset: {
      printer: 'Perfil de impresora',
      process: 'Perfil de proceso',
  ...
  maintenanceDescriptions: {
    ...
    printerCalibration: 'Nivelación de la cama, compensación de vibraciones y cancelación del ruido de los motores, ejecutadas por la propia impresora',
    visionEncoderCalibration: 'Calibración de precisión de movimiento del codificador de visión (serie H2), ejecutada por la propia impresora',
  },
  ...
  notifications: {
    ...
    printConfirmRequest: 'Confirmación de resultado',
    printConfirmRequestDescription: 'Solicitar un veredicto de buena/rechazo con enlaces de un solo toque cuando se complete una impresión que lo tenga activado',
    ...
    maintenanceDue: 'Mantenimiento pendiente',
    maintenanceDueDescription: 'Notificar cuando se necesite mantenimiento',
    maintenanceRun: 'Ejecución de mantenimiento finalizada',
    maintenanceRunDescription: 'Notificar cuando una calibración iniciada por Bambuddy se complete, falle o se cancele',
    ...
    paCalibration: 'Calibración',
    paCalibrationTitle: 'Calibración de dinámica de flujo',
    paCalibrationDescription: 'Una medición de avance de presión terminó y espera guardarse, o la ejecución acabó',
    ...
    eventTypes: {
      ...
      maintenance_run: 'Ejecución de mantenimiento finalizada',
      test: 'Prueba',
    },
