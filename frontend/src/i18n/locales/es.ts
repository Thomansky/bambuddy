export default {
  ...
  printers: {
    ...
    modal: {
      ...
      expectedLifetimeHours: 'Vida útil prevista (horas)',
      depreciationHelp: 'Carga el desgaste de la impresora por hora de impresión a las impresiones futuras. Deja ambos campos vacíos para desactivarlo.',
      depreciationRate: '≈ {{rate}} {{currency}}/h de desgaste de la impresora',
