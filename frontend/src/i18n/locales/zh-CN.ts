export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: '正在等待流量动态校准结束',
  ...
  archives: {
    ...
    filterUnconfirmed: '待确认',
    filterUnconfirmedTitle: '仅显示仍在等待成品判定的打印',
    ...
    card: {
      ...
      printerWear: '打印机损耗',
      printerWearDetail: '{{hours}} 小时 × {{rate}} {{currency}}/小时',
  ...
  stats: {
    ...
    rejectedPrintsCount: '{{rejected}} 个完成后被报废',
    yieldRate: '良品率：{{rate}}%',
  ...
  maintenance: {
    ...
    section: {
      automatic: '自动执行',
      automaticHint: '到期且打印机空闲时，Bambuddy 会自动在打印机上执行，你只会收到通知。',
      manual: '由你完成',
      manualHint: '一条提醒。Bambuddy 负责跟踪到期时间，动手和勾选由你完成。',
    },
    noItems: '尚未设置任何维护',
    ...
    calibration: {
      ...
      lastRunCancelled: '上次运行已取消 {{time}}',
      runQueuedToast: '校准已排队',
      runCancelledToast: '校准运行已取消',
      runsCalibration: '执行校准',
    },
  },
  ...
  settings: {
    ...
    autoLinkScannedSpools: '自动关联扫描的料盘',
    autoLinkScannedSpoolsDesc: '当扫描或自动添加的料盘与现有产品匹配时，将其关联到该料盘，使其带有完整的耗材数据 — 包括每公斤价格。',
    filamentChecks: '耗材检查',
    ...
    rfidAfterPrintUnloadLabel: '读取前先退料',
    rfidAfterPrintUnloadDescription: '打印结束时仍装载着料丝的打印机无法读取任何标签：AMS 必须移动料丝才能靠近标签。启用后会先把料丝退回 AMS，然后再读取。之后打印机保持退料状态，下一次打印会装载它需要的料丝。已经退过料的打印机（通常的情况）绝不会收到退料指令。',
    staggeredStart: '错峰启动',
    ...
    suppliers: {
      title: '供应商',
      description: '管理耗材的购买渠道——不同于品牌，品牌是耗材的制造商。可在料盘对话框中为料盘分配供应商；仍被料盘引用的供应商无法删除。',
      search: '搜索供应商...',
      addNew: '添加新供应商',
      namePlaceholder: '名称（例如 Filament24）',
      websitePlaceholder: '网站/商店链接',
      customerNumberPlaceholder: '客户编号',
      notePlaceholder: '备注',
      nameRequired: '名称为必填项',
      customerNumber: '客户编号',
      spools: '料盘',
      ...
      deleteBlocked: '无法删除：仍分配给 {{count}} 个料盘',
      loadFailed: '加载供应商失败',
      deleteTitle: '删除供应商',
      deleteConfirm: '确定删除“{{name}}”吗？',
      deleteConfirmReferenced: '“{{name}}”已分配给 {{count}} 个料盘。请先移除这些分配后才能删除。',
    },
    catalog: {
      spoolCatalog: '耗材目录',
    ...
    libraryRootView: '根目录显示的内容',
    libraryRootViewAll: '所有文件',
    libraryRootViewAllDescription: '库中的每个文件，汇成一个平铺列表。',
    libraryRootViewFolders: '仅文件夹',
    libraryRootViewFoldersDescription: '顶层文件夹，以及用于不属于任何文件夹的文件的“无文件夹”条目。',
    libraryRootViewRecent: '最近添加或修改的',
    libraryRootViewRecentDescription: '整个库中最新的文件，最多 100 个 — 这是起始页而非列表。',
    libraryRootViewDescription: '无论选择哪一项，搜索和标签筛选始终覆盖整个库。',
    webdavMode: 'WebDAV 访问',
    webdavDescription: '通过 WebDAV 提供文件管理器的目录树，便于工作站将其映射为驱动器。',
    webdavModeOff: '关闭',
    webdavModeOffDescription: '该地址返回 404，与从未启用过此功能的安装完全一致。',
    webdavModeRead: '只读',
    webdavModeReadDescription: '可以打开和复制文件；在映射驱动器上所做的任何操作都不会改动库。',
    webdavModeReadWrite: '读写',
    webdavModeReadWriteDescription: '还可以从驱动器保存、重命名、移动和删除，并沿用网页界面相同的库权限。',
    ...
    webdavHttpsHint: '请通过 HTTPS 提供，因为 Basic 凭据会随每一个请求一起发送。',
    ...
    webdavWriteHint: '覆盖保存会沿用同一条库记录，保留其标签和备注，只替换内容——既不生成版本也不生成变体。删除会把文件移入回收站，而从驱动器新建的文件夹不会分配编号。',
    libraryStorageMode: '文件库存放位置',
    libraryStorageDescription: '文件管理器把文件放在哪里：Bambuddy 自己的存储区，或者只做索引的目录树。',
    libraryStorageModeManaged: 'Bambuddy 自有文件库',
    libraryStorageModeManagedDescription: '文件位于 Bambuddy 数据目录，只能通过 Bambuddy 访问。外部无法移动它们，因此数据库与磁盘始终一致。',
    libraryStorageModeDirectory: '目录',
    libraryStorageModeDirectoryDescription: '你指定的目录（通常是网络共享）本身成为文件库：每个文件夹都是真实目录，每个文件保留真实名称，同一棵树可以在资源管理器中打开。',
    libraryStoragePath: '目录路径',
    libraryStoragePathHint: 'Bambuddy 服务器所见的绝对路径，因此共享需要先挂载在那里。该路径必须存在、可写，并且位于 Bambuddy 自身数据目录之外。',
    libraryStorageDriftHint: '直接在目录里移动或删除的内容，在扫描该文件夹之前 Bambuddy 看不到，因此扫描会成为日常操作，而不是一次性的事。',
    libraryStorageHashHint: '扫描发现的文件不计算哈希——读取共享上的每个文件需要完整遍历一次——所以它们不参与重复检测。通过 Bambuddy 写入的文件仍会像以前一样计算哈希。',
    libraryStorageMigration: '把现有文件库迁入目录',
    libraryStorageMigrationHint: '仅切换模式不会移动任何东西。这里会把每个文件复制到树中的对应位置，校验副本，然后才删除原文件。该操作可以随时再次运行，并接着移动剩下的部分。',
    libraryStoragePlanButton: '查看将要移动的内容',
    libraryStorageMigrateButton: '立即移动',
    libraryStoragePlanSummary: '待移动 {{files}} 个文件、{{folders}} 个文件夹，共 {{size}}。',
    libraryStorageMigrationDone: '已移动 {{files}} 个文件，新建 {{folders}} 个目录。',
    libraryStorageMigrationFailed: '无法开始迁移。',
    libraryStoragePathRequired: '请先填写路径。',
    ...
    libraryStorageScanDone: '扫描完成：新增 {{added}}，移除 {{removed}}。',
    libraryStoragePlanFirst: '请先查看将要移动的内容。',
    libraryStorageBlocked: '有 {{blockers}} 处文件名冲突，移动已被阻止：',
    libraryStorageBlockerCollision: '{{first}} 与 {{second}} 会变成同一个文件，请重命名其中一个。',
    libraryStorageBlockerExists: '{{name}} 在那里已经存在。请在共享上移动或重命名它。',
    storageUsageLibraryTree: '文件库的文件位于 {{path}}。',
    storageUsageLibraryTreeFree: '{{total}} 中剩余 {{free}}',
  ...
  fileManager: {
    ...
    renderingPreviews: '正在生成预览…… {{done}}/{{total}}',
    generateThumbnailsForMissing: '为缺少预览图的 STL 和 PDF 文件生成缩略图',
    gridView: '网格视图',
    listView: '列表视图',
    columnsView: '分栏视图',
    lowDiskSpaceWarning: '磁盘空间不足警告',
    ...
    noFolder: '无文件夹',
    recentCrumb: '最近',
    sortedByRecent: '按添加或修改时间排序',
    pathBar: {
      label: '位置',
      showHidden: '显示折叠的文件夹',
      editPath: '编辑路径',
      noSuchFolder: '没有这个文件夹',
      siblings: '此层级的文件夹',
    },
    search: {
    ...
    toast: {
      ...
      previewsRendered: '已在浏览器中生成 {{count}} 个预览图',
  ...
  inventory: {
    ...
    vatInclShort: '含税',
    vatExclShort: '不含税',
    vatConvertedIncl: '= {{value}}（含税）',
    vatConvertedExcl: '= {{value}}（不含税）',
    ...
    suppliers: {
      ...
      purchaseSource: '在此购买',
      purchaseSourceHelp: '标记此料盘的实际购买来源；其他条目为备选购买渠道。',
      articleNumberPlaceholder: '供应商货号',
      pricePlaceholder: '报价/kg',
      priceHelp: '此供应商的报价，用于比较购买渠道；料盘自身的每公斤成本仍作为成本依据。',
      help: '此产品的可购买渠道。高亮条目为此料盘的实际购买来源。',
      saveFailed: '保存供应商分配失败',
    },
    linked: {
      column: '已关联',
      indicatorTooltip: '已关联料盘 — 耗材数据与其分组共享',
      linkTitle: '关联料盘',
      pickSourceHint: '选择以其耗材数据为准的料盘。其品牌、颜色、重量、温度、价格和备注将复制到其他料盘，并在之后保持同步。剩余重量、标签、位置和历史记录始终按料盘独立保存。',
      searchPlaceholder: '搜索料盘…',
      noCandidates: '没有可选择的料盘',
      alreadyLinked: '已关联',
      linkConfirm: '此操作将覆盖 {{count}} 个料盘的耗材数据。',
      linkAction: '关联',
      linkedToast: '已关联 — 已更新 {{count}} 条记录',
      linkFailed: '关联料盘失败',
      banner: '已与其他 {{count}} 个料盘关联 — 耗材数据的更改将应用于所有关联料盘。',
      notLinked: '未与其他料盘关联。',
      linkWithExisting: '与现有料盘关联…',
      unlinkAction: '解除关联',
      unlinkedToast: '料盘已解除关联',
      unlinkFailed: '解除料盘关联失败',
      propagateTitle: '应用到已关联的料盘？',
      propagateConfirm: '此更改还会更新 {{count}} 个已关联料盘的耗材数据。剩余重量、标签、位置和历史记录不受影响。',
    },
  ...
  paCalibration: {
    ...
    noProfileYet: '尚无配置',
    cost: '耗时',
    costValue: '约 {{minutes}} 分钟，约 {{grams}} 克',
    plateType: '热床上的打印板',
    plateTypeHint: '线条按此打印板切片，必须与热床上实际使用的打印板一致。',
    presetsHint: '使用这些预设切片。第三方耗材请选择对应的耗材预设。',
    plateConfirm: '打印板已清空，打印出的线条稍后可以清除。',
    start: '开始校准',
    save: '保存到打印机',
    discard: '丢弃',
    cancelPrintConfirm: '要停止校准打印吗？',
    oldK: '已保存 K 值',
    newK: '测得 K 值',
    nCoef: '流量系数',
    confidence: '置信度',
    willOverwrite: '保存将替换现有的 K 值配置。',
    willCreate: '保存将新建一个 K 值配置并绑定到该料槽。',
    notLoaded: '未装入任何料槽',
    noPermission: '您没有在此打印机上启动打印的权限。',
    blocked: {
      model_not_supported: '此打印机暂不支持。',
      printer_offline: '打印机已离线。',
      printer_busy: '打印机正在打印。',
      printer_reserved: '打印机已被其他任务占用。',
      run_already_active: '该打印机上已有一次校准在进行。',
      slicer_not_configured: '切片服务无法连接。该校准是一次切片打印，必须依赖它。',
      slot_empty: '该料槽中没有已识别的耗材。',
      nozzle_unknown: '打印机尚未上报当前安装的喷嘴。',
      printer_preset_unavailable: '切片器没有适用于该打印机与喷嘴的内置配置。',
    },
    status: {
      queued: '等待打印机',
      slicing: '切片中',
    ...
    waiting: {
      printer_offline: '等待打印机重新上线',
      printer_busy: '等待打印机完成当前任务',
      printer_reserved: '等待队列释放打印机',
      plate_not_cleared: '等待确认打印板已清空',
    },
    plates: {
      cool_plate: '冷板',
      eng_plate: '工程板',
      hot_plate: '光面 PEI 板',
      textured_plate: '纹理 PEI 板',
    },
    preset: {
      printer: '打印机预设',
      process: '工艺预设',
  ...
  notifications: {
    ...
    printConfirmRequest: '成品确认',
    printConfirmRequestDescription: '当已启用询问的打印完成时，通过一键链接请求良品/报废判定',
    plateClear: '热床确认',
    ...
    paCalibration: '校准',
    paCalibrationTitle: '流量动态校准',
    paCalibrationDescription: '压力提前量测量完成、等待保存，或本次运行已结束',
