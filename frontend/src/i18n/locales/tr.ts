export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: 'Akış dinamiği kalibrasyonunun bitmesi bekleniyor',
  ...
  archives: {
    ...
    filterUnconfirmed: 'Onaylanmamış',
    filterUnconfirmedTitle: 'Yalnızca sonuç kararı bekleyen baskıları göster',
    ...
    card: {
      ...
      printerWear: 'Yazıcı aşınması',
      printerWearDetail: '{{hours}} sa × {{rate}} {{currency}}/sa',
    ...
    log: {
      ...
      depreciationCost: 'Yazıcı Aşınması',
      completedAt: 'Bitti',
      jobNumber: 'İş no',
      columns: 'Sütunlar',
  ...
  stats: {
    ...
    rejectedPrintsCount: '{{rejected}} tamamlandıktan sonra reddedildi',
    yieldRate: 'Verim: %{{rate}}',
  ...
  maintenance: {
    ...
    section: {
      automatic: 'Kendiliğinden çalışır',
      automaticHint: 'Zamanı geldiğinde ve yazıcı boştayken Bambuddy bunları kendisi başlatır; siz yalnızca haberdar edilirsiniz.',
      manual: 'Siz yaparsınız',
      manualHint: 'Bir hatırlatma. Bambuddy zamanını izler; işi yapmak ve işaretlemek size kalır.',
    },
    noItems: 'Henüz bakım tanımlanmadı',
    ...
    calibration: {
      option: {
        bed_leveling: 'Tabla seviyeleme',
        vibration: 'Titreşim telafisi',
        motor_noise: 'Motor gürültüsü giderme',
        nozzle_offset: 'Nozul ofseti',
        high_temp_heatbed: 'Yüksek sıcaklıkta tabla seviyeleme',
      ...
      runningSince: 'Kalibrasyon {{time}} itibarıyla çalışıyor',
      nextRunAt: 'Sonraki çalıştırma: {{time}}',
      ...
      lastRunCancelled: 'Son çalıştırma iptal edildi {{time}}',
      runQueuedToast: 'Kalibrasyon sıraya alındı',
      runCancelledToast: 'Kalibrasyon çalıştırması iptal edildi',
      runsCalibration: 'Bir kalibrasyon çalıştırır',
    },
  },
  ...
  settings: {
    ...
    autoLinkScannedSpools: 'Taranan makaraları otomatik bağla',
    autoLinkScannedSpoolsDesc: 'Taranan veya otomatik eklenen bir makara mevcut bir ürünle eşleşirse, kg başına fiyat dahil tüm filament verileriyle gelmesi için o makaraya bağlanır.',
    ...
    rfidAfterPrintDescription: 'Aynı okuma, diğer uçta: bir baskı bittiğinde yazıcı boştur, AMS filamenti hareket ettirebilir ve hiçbir iş yanıtı beklemez. Tamamlanmış ya da başarısız, her baskıdan sonra çalışır. AMS yalnızca hiçbir şey takılı değilken okuyabilir — yazıcılar bitişte filamenti genelde geri çeker — bu yüzden nozulunda hâlâ makara olan bir yazıcı bir sonraki baskıdan sonraya bırakılır. Yeni bir baskı başlarsa hemen durur ve otomatik kapatma okumanın bitmesini bekler.',
    rfidAfterPrintUnloadLabel: 'Okumadan önce boşalt',
    rfidAfterPrintUnloadDescription: 'Baskısı bittiğinde hâlâ filament yüklü olan bir yazıcı hiçbir etiketi okuyamaz: AMS etikete ulaşmak için filamenti hareket ettirmek zorundadır. Bu seçenek açıkken filament önce AMS içine geri çekilir, okuma ancak ondan sonra yapılır. Yazıcı sonrasında boş kalır; bir sonraki baskı neye ihtiyacı varsa onu yükler. Filamenti zaten geri çekmiş bir yazıcıya — ki olağan durum budur — hiçbir zaman boşaltma komutu gönderilmez.',
    ...
    suppliers: {
      title: 'Tedarikçiler',
      description: 'Filamenti nereden satın aldığınızı yönetin — bunu üreten firmayı belirten markadan farklıdır. Makara iletişim kutusunda makaralara tedarikçi atayın; hâlâ makaralara atanmış bir tedarikçi silinemez.',
      search: 'Tedarikçi ara...',
      addNew: 'Yeni tedarikçi ekle',
      namePlaceholder: 'Ad (örn. Filament24)',
      websitePlaceholder: 'Web sitesi / mağaza URL\'si',
      customerNumberPlaceholder: 'Müşteri no.',
      notePlaceholder: 'Not',
      nameRequired: 'Ad gereklidir',
      customerNumber: 'Müşteri no.',
      spools: 'Makaralar',
      noMatch: 'Aramanızla eşleşen tedarikçi yok',
      empty: 'Henüz tedarikçi yok',
      added: 'Tedarikçi eklendi',
      addFailed: 'Tedarikçi eklenemedi',
      ...
      deleteBlocked: 'Silinemez: hâlâ {{count}} makaraya atanmış',
      loadFailed: 'Tedarikçiler yüklenemedi',
      deleteTitle: 'Tedarikçiyi Sil',
      deleteConfirm: '"{{name}}" silinsin mi?',
      deleteConfirmReferenced: '"{{name}}" {{count}} makaraya atanmış. Bu atamalar kaldırılana kadar silme engellenir.',
    },
    catalog: {
    ...
    libraryRootView: 'Kökün gösterdiği içerik',
    libraryRootViewAll: 'Tüm dosyalar',
    libraryRootViewAllDescription: 'Kitaplıktaki her dosya tek bir düz listede.',
    libraryRootViewFolders: 'Yalnızca klasörler',
    libraryRootViewFoldersDescription: 'En üst düzey klasörler ve hiçbir klasörde olmayan dosyalar için bir «Klasörsüz» girdisi.',
    libraryRootViewRecent: 'Son eklenen veya değiştirilenler',
    libraryRootViewRecentDescription: 'Kitaplığın tamamındaki en yeni dosyalar, en fazla 100 tanesi - liste değil, bir başlangıç sayfası.',
    libraryRootViewDescription: 'Hangisi seçilirse seçilsin, arama ve etiket filtreleri her zaman kitaplığın tamamını kapsar.',
    webdavMode: 'WebDAV erişimi',
    webdavDescription: 'Dosya Yöneticisi ağacını WebDAV üzerinden yayınlar; bir iş istasyonu onu sürücü olarak bağlayabilir.',
    webdavModeOff: 'Kapalı',
    webdavModeOffDescription: 'Adres 404 yanıtı verir; bu özelliğin hiç bulunmadığı bir kurulumdaki davranışın aynısı.',
    webdavModeRead: 'Salt okunur',
    webdavModeReadDescription: 'Dosyalar açılabilir ve kopyalanabilir; bağlanan sürücüde yapılan hiçbir şey kitaplığı değiştirmez.',
    webdavModeReadWrite: 'Okuma ve yazma',
    webdavModeReadWriteDescription: 'Sürücüden kaydetme, yeniden adlandırma, taşıma ve silme de mümkündür; web arayüzünün uyguladığı kitaplık izinleri geçerlidir.',
    ...
    webdavHttpsHint: 'Basic kimlik bilgileri her bir istekle birlikte gittiği için HTTPS üzerinden yayınlayın.',
    ...
    webdavWriteHint: 'Bir dosyanın üzerine kaydetmek aynı kitaplık kaydını, etiketleri ve notlarıyla korur ve yalnızca içeriği değiştirir — sürüm de varyant da oluşmaz. Silinen dosya çöp kutusuna gider ve sürücüden oluşturulan klasöre numara verilmez.',
    libraryStorageMode: 'Kitaplık depolaması',
    libraryStorageDescription: 'Dosya yöneticisinin dosyalarını nerede tuttuğu: Bambuddy\'nin kendi deposunda ya da yalnızca dizinlediği bir dizin ağacında.',
    libraryStorageModeManaged: 'Bambuddy\'nin kendi kitaplığı',
    libraryStorageModeManagedDescription: 'Dosyalar Bambuddy veri dizininde durur ve yalnızca Bambuddy üzerinden erişilir. Dışarıdan hiçbir şey onları taşıyamaz, bu yüzden veritabanı ile disk her zaman uyuşur.',
    libraryStorageModeDirectory: 'Dizin',
    libraryStorageModeDirectoryDescription: 'Seçtiğin bir dizin — genelde bir ağ paylaşımı — kitaplığın kendisi olur: her klasör gerçek bir dizindir, her dosya gerçek adını korur ve aynı ağaç Dosya Gezgini\'nde açılır.',
    libraryStoragePath: 'Dizin yolu',
    libraryStoragePathHint: 'Bambuddy sunucusunun gördüğü biçimde mutlak yol, yani paylaşımın önce orada bağlanmış olması gerekir. Var olmalı, yazılabilir olmalı ve Bambuddy\'nin kendi veri dizinlerinin dışında kalmalıdır.',
    libraryStorageDriftHint: 'Doğrudan dizinde taşınan ya da silinen her şey, klasör taranana kadar Bambuddy için görünmezdir; böylece tarama tek seferlik bir iş değil, rutinin parçası olur.',
    libraryStorageHashHint: 'Taramanın bulduğu dosyaların özeti alınmaz — bir paylaşımdaki her dosyayı okumak tam bir geçiş demektir — bu yüzden yineleme algılamasına katılmazlar. Bambuddy üzerinden yazılan dosyalar eskiden olduğu gibi özetlenir.',
    libraryStorageMigration: 'Var olan kitaplığı dizine taşı',
    libraryStorageMigrationHint: 'Kipi değiştirmek tek başına hiçbir şeyi taşımaz. Burada her dosya ağaçtaki yerine kopyalanır, kopya denetlenir ve ancak sonra özgün dosya silinir. İşlem her zaman yeniden başlatılabilir ve kalanı taşır.',
    libraryStoragePlanButton: 'Nelerin taşınacağını göster',
    libraryStorageMigrateButton: 'Şimdi taşı',
    libraryStoragePlanSummary: '{{files}} dosya, {{folders}} klasör, {{size}} taşınacak.',
    libraryStorageMigrationDone: '{{files}} dosya taşındı, {{folders}} dizin oluşturuldu.',
    ...
    libraryStorageScanDone: 'Tarama bitti: {{added}} eklendi, {{removed}} kaldırıldı.',
    ...
    libraryStorageBlockerExists: '{{name}} orada zaten var. Paylaşımda taşı ya da yeniden adlandır.',
    storageUsageLibraryTree: 'Kitaplık dosyaları {{path}} üzerinde.',
    storageUsageLibraryTreeFree: '{{total}} alanın {{free}} kadarı boş',
    // Güncellemeler
  ...
  fileManager: {
    ...
    renderingPreviews: 'Önizlemeler oluşturuluyor… {{done}}/{{total}}',
    generateThumbnailsForMissing: 'Önizlemesi olmayan STL ve PDF dosyaları için küçük resimler oluştur',
    gridView: 'Izgara görünümü',
    listView: 'Liste görünümü',
    ...
    noFolder: 'Klasörsüz',
    recentCrumb: 'Son eklenenler',
    sortedByRecent: 'Eklenme veya değiştirilme zamanına göre sıralanmış',
    pathBar: {
      label: 'Konum',
      showHidden: 'Gizlenen klasörleri göster',
      editPath: 'Yolu düzenle',
      noSuchFolder: 'Böyle bir klasör yok',
      siblings: 'Bu düzeydeki klasörler',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        date: 'Tarih',
        attachments: 'Ekler',
        noBody: 'Bu iletinin metin gövdesi yok.',
        rtfNote: 'Zengin metin içeriğinden çıkarılan metin — biçimlendirme sadeleştirilmiştir.',
      },
    },
    details: {
    ...
    toast: {
      ...
      previewsRendered: 'Tarayıcıda {{count}} önizleme oluşturuldu',
  ...
  inventory: {
    ...
    vatInclShort: 'dahil',
    vatExclShort: 'hariç',
    vatConvertedIncl: '= {{value}} KDV dahil',
    vatConvertedExcl: '= {{value}} KDV hariç',
    ...
    suppliers: {
      ...
      noneLeft: 'Tüm tedarikçiler zaten atanmış',
      createNew: '"{{name}}" oluştur',
      createFailed: 'Tedarikçi oluşturulamadı',
      purchaseSource: 'Buradan satın alındı',
      purchaseSourceHelp: 'Bu makaranın gerçekte nereden satın alındığını işaretler; diğer girişler alternatif kaynaklardır.',
      articleNumberPlaceholder: 'Tedarikçi ürün no.',
      pricePlaceholder: 'Teklif fiyatı/kg',
      priceHelp: 'Bu tedarikçideki teklif fiyatı, kaynakları karşılaştırmak içindir — makaranın kendi kg başına maliyeti, maliyet esası olarak kalır.',
      help: 'Bu ürünün satın alınabileceği yerler. Vurgulanan giriş, bu makaranın satın alındığı yerdir.',
      saveFailed: 'Tedarikçi atamaları kaydedilemedi',
    },
    linked: {
      column: 'Bağlı',
      indicatorTooltip: 'Bağlı makara — filament verileri grubuyla paylaşılıyor',
      linkTitle: 'Makaraları Bağla',
      pickSourceHint: 'Filament verileri esas alınacak makarayı seçin. Marka, renk, ağırlıklar, sıcaklıklar, fiyat ve notlar diğerlerine kopyalanır ve bundan sonra senkronize kalır. Kalan ağırlık, etiketler, konumlar ve geçmiş her zaman makaraya özel kalır.',
      searchPlaceholder: 'Makara ara…',
      noCandidates: 'Seçilecek makara yok',
      alreadyLinked: 'bağlı',
      linkConfirm: 'Bu işlem {{count}} makaranın filament verilerinin üzerine yazacak.',
      linkAction: 'Bağla',
      linkedToast: 'Bağlandı — {{count}} kayıt güncellendi',
      linkFailed: 'Makaralar bağlanamadı',
      banner: '{{count}} başka makarayla bağlı — filament verisi değişiklikleri hepsine uygulanır.',
      notLinked: 'Başka makaralara bağlı değil.',
      linkWithExisting: 'Mevcut makarayla bağla…',
      unlinkAction: 'Bağlantıyı Kaldır',
      unlinkedToast: 'Makara bağlantısı kaldırıldı',
      unlinkFailed: 'Makara bağlantısı kaldırılamadı',
      propagateTitle: 'Bağlı makaralara uygulansın mı?',
      propagateConfirm: 'Bu değişiklik, bağlı {{count}} makaranın filament verilerini de günceller. Kalan ağırlık, etiketler, konumlar ve geçmiş olduğu gibi kalır.',
    },
    ...
    stockValuePurchase: 'Alış değeri: {{value}}',
    stockValueUnpriced: '{{count}} fiyatsız',
    stockValueUnpricedTooltip: 'Kg başına fiyatı olmayan makaralar değere dahil edilmez.',
  ...
  confirmOutcome: {
    title: 'Baskınız nasıl çıktı?',
    good: 'İyi',
    reject: 'Ret',
    later: 'Daha sonra sor',
    noPhoto: 'Bitiş fotoğrafı mevcut değil',
    savedGood: 'İyi parça olarak işaretlendi',
    savedReject: 'Reddedildi olarak işaretlendi',
    saveFailed: 'Karar kaydedilemedi',
    rejectReason: 'Ret nedeni (isteğe bağlı)',
    noReason: 'Neden yok',
    saveReject: 'Kaydet',
  ...
  // Sanal Yazıcı
  paCalibration: {
    title: 'Akış dinamiği kalibrasyonu',
    menuAction: 'Akış dinamiğini kalibre et…',
    printer: 'Yazıcı',
    nozzle: 'Nozul',
    slot: 'Yuva',
    currentK: 'Geçerli K',
    ...
    cost: 'Süre',
    costValue: 'yaklaşık {{minutes}} dk, yaklaşık {{grams}} g',
    plateType: 'Tablada duran baskı plakası',
    plateTypeHint: 'Çizgi bu plakaya göre dilimlenir, bu yüzden gerçekten takılı olanla aynı olmalıdır.',
    presetsHint: 'Bu ön ayarlarla dilimlenir. Üçüncü taraf makara için uygun filament profilini seçin.',
    plateConfirm: 'Baskı plakası boş ve basılan çizgi sonradan çıkarılabilir.',
    start: 'Kalibrasyonu başlat',
    save: 'Yazıcıya kaydet',
    discard: 'At',
    cancelPrintConfirm: 'Kalibrasyon baskısı durdurulsun mu?',
    oldK: 'Kayıtlı K',
    newK: 'Ölçülen K',
    nCoef: 'Akış katsayısı',
    confidence: 'Güven değeri',
    willOverwrite: 'Kaydetmek mevcut K profilinin yerine geçer.',
    willCreate: 'Kaydetmek yeni bir K profili oluşturur ve bu yuvaya bağlar.',
    notLoaded: 'Hiçbir yuvaya yüklü değil',
    noPermission: 'Bu yazıcıda baskı başlatma izniniz yok.',
    blocked: {
      model_not_supported: 'Bu yazıcıda henüz desteklenmiyor.',
      printer_offline: 'Yazıcı çevrimdışı.',
      printer_busy: 'Yazıcı şu anda baskı yapıyor.',
      printer_reserved: 'Yazıcı başka bir iş için ayrılmış.',
      run_already_active: 'Bu yazıcıda hâlihazırda bir kalibrasyon çalışıyor.',
      slicer_not_configured: 'Dilimleyici servisine ulaşılamıyor. Bu kalibrasyon dilimlenmiş bir baskıdır ve ona ihtiyaç duyar.',
      slot_empty: 'Yuvada tanımlı filament yok.',
      nozzle_unknown: 'Yazıcı hangi nozulun takılı olduğunu bildirmedi.',
      printer_preset_unavailable: 'Dilimleyicide bu yazıcı ve nozul için hazır profil yok.',
    },
    status: {
      queued: 'Yazıcı bekleniyor',
      slicing: 'Dilimleniyor',
      uploading: 'Yükleniyor',
      printing: 'Baskı yapılıyor',
      reading_result: 'Sonuç okunuyor',
      awaiting_confirmation: 'Kararınız bekleniyor',
      saving: 'Yazıcıya kaydediliyor',
      done: 'Kaydedildi',
      failed: 'Başarısız',
      cancelled: 'İptal edildi',
    },
    waiting: {
      printer_offline: 'Yazıcının yeniden çevrimiçi olması bekleniyor',
      printer_busy: 'Yazıcının mevcut işini bitirmesi bekleniyor',
      printer_reserved: 'Kuyruğun yazıcıyı serbest bırakması bekleniyor',
      plate_not_cleared: 'Baskı plakasının boş olduğunun onaylanması bekleniyor',
    },
    plates: {
      cool_plate: 'Soğuk plaka',
      eng_plate: 'Mühendislik plakası',
      hot_plate: 'Düz PEI plakası',
      textured_plate: 'Dokulu PEI plakası',
    },
    preset: {
      printer: 'Yazıcı ön ayarı',
      process: 'İşlem ön ayarı',
  ...
  notifications: {
    ...
    printConfirmRequest: 'Sonuç Onayı',
    printConfirmRequestDescription: 'Onay istenen bir baskı tamamlandığında tek dokunuş bağlantılarıyla iyi/ret kararı iste',
    ...
    paCalibration: 'Kalibrasyon',
    paCalibrationTitle: 'Akış dinamiği kalibrasyonu',
    paCalibrationDescription: 'Bir pressure advance ölçümü bitti ve kaydedilmeyi bekliyor ya da çalışma sona erdi',
