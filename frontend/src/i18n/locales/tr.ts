export default {
  ...
  printers: {
    ...
    modal: {
      ...
      purchasePrice: 'Satın alma fiyatı (isteğe bağlı)',
      expectedLifetimeHours: 'Beklenen ömür (saat)',
      depreciationHelp: 'Gelecekteki baskılara baskı saati başına yazıcı aşınması ekler. Devre dışı bırakmak için iki alanı da boş bırakın.',
      depreciationRate: '≈ {{rate}} {{currency}}/sa yazıcı aşınması',
