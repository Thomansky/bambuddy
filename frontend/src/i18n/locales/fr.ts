export default {
  ...
  printers: {
    ...
    drying: {
      ...
      waitingPaCalibration: "En attente de la fin d'un calibrage de dynamique d'écoulement",
  ...
  archives: {
    ...
    filterUnconfirmed: 'Non confirmées',
    filterUnconfirmedTitle: 'Afficher uniquement les impressions en attente de leur verdict de résultat',
    ...
    card: {
      ...
      printerWear: 'Usure de l\'imprimante',
      printerWearDetail: '{{hours}} h × {{rate}} {{currency}} par heure',
  ...
  queue: {
    ...
    badges: {
      ...
      confirmOutcome: 'Demande de résultat',
      confirmOutcomeTitle: 'Demande comment l’impression s’est déroulée une fois terminée',
    },
    // Empty state
    empty: {
    ...
    bulkEdit: {
      ...
      useAms: 'Utiliser AMS',
      confirmOutcome: 'Demander le résultat',
  ...
  stats: {
    ...
    rejectedPrintsCount: '{{rejected}} rebutées après achèvement',
    yieldRate: 'Rendement : {{rate}}%',
  ...
  maintenance: {
    ...
    section: {
      automatic: "S'exécute toute seule",
      automaticHint: "Bambuddy les lance sur l'imprimante dès qu'elles sont dues et qu'elle est libre ; vous êtes seulement prévenu.",
      manual: 'Vous la faites',
      manualHint: "Un rappel. Bambuddy suit l'échéance ; le travail et la validation vous reviennent.",
    },
    noItems: 'Aucune maintenance configurée pour le moment',
    ...
    calibration: {
      option: {
        bed_leveling: 'Nivellement du plateau',
        vibration: 'Compensation des vibrations',
        motor_noise: 'Suppression du bruit moteur',
        nozzle_offset: 'Décalage de buse',
        high_temp_heatbed: 'Nivellement du plateau à haute température',
      ...
      runningSince: 'Calibration en cours depuis {{time}}',
      nextRunAt: 'Prochaine exécution : {{time}}',
      ...
      lastRunCancelled: 'Dernière exécution annulée {{time}}',
      runQueuedToast: 'Calibration mise en attente',
      runCancelledToast: 'Exécution de calibration annulée',
      runsCalibration: 'Lance une calibration',
    },
  },
  ...
  settings: {
    ...
    autoLinkScannedSpools: 'Lier automatiquement les bobines scannées',
    autoLinkScannedSpoolsDesc: 'Lorsqu\'une bobine scannée ou ajoutée automatiquement correspond à un produit existant, elle est liée à cette bobine et arrive ainsi avec les données de filament complètes — prix au kg compris.',
    ...
    rfidAfterPrintDescription: "La même lecture à l'autre bout : quand une impression se termine, l'imprimante est libre, l'AMS peut déplacer le filament et aucun travail n'attend la réponse. S'exécute après chaque impression, terminée ou échouée. L'AMS ne peut lire que si rien n'est chargé — les imprimantes rétractent normalement le filament à la fin — donc une imprimante qui a encore une bobine dans une buse attend l'impression suivante. S'arrête aussitôt si une nouvelle impression démarre et l'extinction automatique attend la fin de la lecture.",
    rfidAfterPrintUnloadLabel: 'Décharger avant la lecture',
    rfidAfterPrintUnloadDescription: "Une imprimante qui a encore du filament chargé à la fin de son impression ne peut lire aucune étiquette : l'AMS doit déplacer du filament pour l'atteindre. Avec cette option, le filament est d'abord rétracté dans l'AMS, puis la lecture a lieu. L'imprimante reste déchargée ensuite ; l'impression suivante chargera ce dont elle a besoin. Une imprimante qui a déjà rétracté son filament, ce qui est le cas habituel, ne reçoit jamais d'ordre de déchargement.",
    ...
    suppliers: {
      title: 'Fournisseurs',
      description: 'Gérez où vous achetez votre filament — à distinguer de la marque, qui désigne le fabricant. Associez les fournisseurs aux bobines dans la boîte de dialogue de la bobine ; un fournisseur encore associé à des bobines ne peut pas être supprimé.',
      search: 'Rechercher des fournisseurs...',
      addNew: 'Ajouter un nouveau fournisseur',
      namePlaceholder: 'Nom (ex. Filament24)',
      websitePlaceholder: 'Site web / URL de la boutique',
      customerNumberPlaceholder: 'N° client',
      ...
      deleteBlocked: 'Suppression impossible : encore associé à {{count}} bobine(s)',
      loadFailed: 'Échec du chargement des fournisseurs',
      deleteTitle: 'Supprimer le fournisseur',
      deleteConfirm: 'Supprimer « {{name}} » ?',
      deleteConfirmReferenced: '« {{name}} » est associé à {{count}} bobine(s). La suppression est bloquée tant que ces associations ne sont pas retirées.',
    },
    catalog: {
    ...
    libraryRootView: 'Ce qu’affiche la racine',
    libraryRootViewAll: 'Tous les fichiers',
    libraryRootViewAllDescription: 'Tous les fichiers de la bibliothèque, dans une liste à plat.',
    libraryRootViewFolders: 'Dossiers uniquement',
    libraryRootViewFoldersDescription: 'Les dossiers de premier niveau, plus une entrée « Sans dossier » pour les fichiers hors de tout dossier.',
    libraryRootViewRecent: 'Ajoutés ou modifiés récemment',
    libraryRootViewRecentDescription: 'Les fichiers les plus récents de toute la bibliothèque, 100 au maximum - une page d’accueil plutôt qu’une liste.',
    libraryRootViewDescription: 'La recherche et les filtres par étiquette portent toujours sur toute la bibliothèque, quel que soit le choix.',
    webdavMode: 'Accès WebDAV',
    ...
    webdavModeOff: 'Désactivé',
    webdavModeOffDescription: 'L’adresse répond 404, exactement comme sur une installation qui n’a jamais eu la fonction.',
    webdavModeRead: 'Lecture seule',
    webdavModeReadDescription: 'Les fichiers peuvent être ouverts et copiés ; rien de ce qui est fait sur le lecteur monté ne modifie la bibliothèque.',
    webdavModeReadWrite: 'Lecture et écriture',
    webdavModeReadWriteDescription: 'Également enregistrer, renommer, déplacer et supprimer depuis le lecteur, avec les mêmes droits de bibliothèque que ceux de l’interface web.',
    ...
    webdavHttpsHint: 'Publiez-le en HTTPS, car les identifiants Basic accompagnent chacune des requêtes.',
    ...
    webdavWriteHint: 'Un enregistrement par-dessus un fichier conserve la même entrée de bibliothèque, avec ses étiquettes et ses notes, et n’en remplace que le contenu : ni version ni variante. Une suppression met le fichier à la corbeille, et un dossier créé depuis le lecteur ne reçoit aucun numéro.',
    libraryStorageMode: 'Stockage de la bibliothèque',
    libraryStorageDescription: 'Où le gestionnaire de fichiers conserve ses fichiers : dans le stockage propre à Bambuddy, ou dans une arborescence de répertoires qu\'il se contente d\'indexer.',
    libraryStorageModeManaged: 'Bibliothèque propre à Bambuddy',
    libraryStorageModeManagedDescription: 'Les fichiers résident dans le répertoire de données de Bambuddy et ne sont accessibles que par lui. Rien d\'extérieur ne peut les déplacer, donc la base de données et le disque concordent toujours.',
    libraryStorageModeDirectory: 'Répertoire',
    libraryStorageModeDirectoryDescription: 'Un répertoire de votre choix — généralement un partage réseau — devient la bibliothèque elle-même : chaque dossier est un vrai répertoire, chaque fichier garde son vrai nom, et la même arborescence s\'ouvre dans l\'explorateur.',
    libraryStoragePath: 'Chemin du répertoire',
    libraryStoragePathHint: 'Chemin absolu tel que le serveur Bambuddy le voit : un partage doit donc y être monté au préalable. Il doit exister, être accessible en écriture et se situer hors des répertoires de données de Bambuddy.',
    libraryStorageDriftHint: 'Tout ce qui est déplacé ou supprimé directement dans le répertoire reste invisible pour Bambuddy jusqu\'à l\'analyse du dossier ; l\'analyse devient donc une habitude et non une opération unique.',
    libraryStorageHashHint: 'Les fichiers découverts par une analyse ne sont pas hachés — lire chaque fichier d\'un partage coûte un parcours complet — et ne participent donc pas à la détection des doublons. Les fichiers écrits via Bambuddy le sont comme avant.',
    libraryStorageMigration: 'Déplacer la bibliothèque existante vers le répertoire',
    libraryStorageMigrationHint: 'Changer de mode ne déplace rien en soi. Ici, chaque fichier est copié à sa place dans l\'arborescence, la copie est vérifiée, et l\'original n\'est retiré qu\'ensuite. L\'opération peut être relancée à tout moment et reprendra ce qui reste.',
    libraryStoragePlanButton: 'Afficher ce qui serait déplacé',
    libraryStorageMigrateButton: 'Déplacer maintenant',
    libraryStoragePlanSummary: '{{files}} fichier(s), {{folders}} dossier(s), {{size}} à déplacer.',
    libraryStorageMigrationDone: '{{files}} fichier(s) déplacé(s), {{folders}} répertoire(s) créé(s).',
    ...
    libraryAutoscan: 'Rester en phase avec le répertoire',
    libraryScanOnOpen: 'Mettre un dossier à jour à son ouverture',
    libraryScanOnOpenHint: 'Chaque fois qu\'un dossier est ouvert dans le gestionnaire de fichiers, il est comparé au répertoire. Ne coûte rien tant que personne n\'utilise Bambuddy.',
    libraryAutoscanHint: 'Ce qui est déplacé ou supprimé directement dans le répertoire ne parvient à Bambuddy que par une analyse. Réglez ici sa fréquence automatique — 0 la désactive et laisse faire le bouton.',
    libraryAutoscanUnit: 'minutes (0 = désactivé)',
    libraryStorageScanButton: 'Analyser maintenant',
    libraryStorageScanDone: 'Analyse terminée : {{added}} ajouté(s), {{removed}} retiré(s).',
    ...
    libraryStorageBlockerExists: '{{name}} existe déjà là-bas. Déplacez-le ou renommez-le sur le partage.',
    storageUsageLibraryTree: 'Les fichiers de la bibliothèque sont sur {{path}}.',
    storageUsageLibraryTreeFree: '{{free}} libres sur {{total}}',
  ...
  fileManager: {
    ...
    renderingPreviews: 'Génération des aperçus… {{done}}/{{total}}',
    generateThumbnailsForMissing: 'Générer les vignettes des fichiers STL et PDF sans aperçu',
    gridView: 'Grille',
    listView: 'Liste',
    ...
    recentCrumb: 'Récents',
    sortedByRecent: 'Trié par date d’ajout ou de modification',
    pathBar: {
      label: 'Emplacement',
      showHidden: 'Afficher les dossiers masqués',
      editPath: 'Modifier le chemin',
      noSuchFolder: 'Ce dossier n’existe pas',
      siblings: 'Dossiers de ce niveau',
    },
    search: {
    ...
    preview: {
      ...
      msg: {
        ...
        noBody: 'Ce message ne contient pas de corps de texte.',
        rtfNote: 'Texte extrait du contenu en texte enrichi — mise en forme simplifiée.',
      },
    },
    details: {
    ...
    toast: {
      ...
      previewsRendered: '{{count}} aperçu(s) généré(s) dans le navigateur',
      thumbnailsGeneratedPartial: '{{succeeded}} succès, {{failed}} échecs',
      noStlMissingThumbnails: 'Aucun fichier STL ou PDF sans vignette',
  ...
  inventory: {
    ...
    vatBasis: 'Base de TVA',
    vatIncl: 'TTC',
    vatExcl: 'HT',
    vatInclShort: 'TTC',
    vatExclShort: 'HT',
    vatConvertedIncl: '= {{value}} TTC',
    vatConvertedExcl: '= {{value}} HT',
    ...
    materialNumberNext: 'Suivant libre',
    materialNumberNextHint: 'Prendre le numéro suivant de la série des numéros de matériau — pour un produit qui n\'en a pas encore.',
    materialNumberNextFailed: 'Aucun numéro de matériau n\'a pu être attribué.',
    ...
    suppliers: {
      ...
      noneLeft: 'Tous les fournisseurs sont déjà associés',
      createNew: 'Créer « {{name}} »',
      createFailed: 'Échec de la création du fournisseur',
      purchaseSource: 'Acheté ici',
      purchaseSourceHelp: 'Indique où cette bobine a réellement été achetée ; les autres entrées sont des sources alternatives.',
      articleNumberPlaceholder: 'Réf. article fournisseur',
      pricePlaceholder: 'Prix proposé/kg',
      priceHelp: 'Prix proposé chez ce fournisseur, pour comparer les sources — le coût par kg propre à la bobine reste la base de coût.',
      help: 'Où ce produit peut être acheté. L\'entrée mise en évidence est celle où cette bobine a été achetée.',
      saveFailed: 'Échec de l\'enregistrement des fournisseurs associés',
    },
    linked: {
      column: 'Liée',
      indicatorTooltip: 'Bobine liée — les données de filament sont partagées avec son groupe',
      linkTitle: 'Lier des bobines',
      pickSourceHint: 'Choisissez la bobine dont les données de filament doivent prévaloir. Sa marque, sa couleur, ses poids, ses températures, son prix et ses notes sont copiés vers les autres et restent ensuite synchronisés. Le poids restant, les tags, les emplacements et l\'historique restent toujours propres à chaque bobine.',
      searchPlaceholder: 'Rechercher des bobines…',
      noCandidates: 'Aucune bobine disponible',
      alreadyLinked: 'liée',
      linkConfirm: 'Cela écrasera les données de filament de {{count}} bobine(s).',
      linkAction: 'Lier',
      linkedToast: 'Liaison effectuée — {{count}} fiche(s) mise(s) à jour',
      linkFailed: 'Échec de la liaison des bobines',
      banner: 'Liée à {{count}} autre(s) bobine(s) — les modifications des données de filament s\'appliquent à toutes.',
      notLinked: 'Non liée à d\'autres bobines.',
      linkWithExisting: 'Lier à une bobine existante…',
      unlinkAction: 'Délier',
      unlinkedToast: 'Bobine déliée',
      unlinkFailed: 'Échec de la suppression de la liaison',
      propagateTitle: 'Appliquer aux bobines liées ?',
      propagateConfirm: 'Cette modification met aussi à jour les données de filament de {{count}} bobine(s) liée(s). Le poids restant, les tags, les emplacements et l\'historique restent inchangés.',
    },
  ...
  printModal: {
    ...
    askForOutcome: 'Demander le résultat',
    askForOutcomeTitle: 'Demander comment l’impression s’est déroulée une fois terminée',
  },
  ...
  confirmOutcome: {
    title: 'Comment votre impression est-elle sortie ?',
    good: 'Bonne',
    reject: 'Rebut',
    later: 'Me redemander plus tard',
    noPhoto: 'Aucune photo de fin disponible',
    savedGood: 'Marquée comme bonne pièce',
    savedReject: 'Marquée comme rebut',
    saveFailed: 'Impossible d\'enregistrer le verdict',
    rejectReason: 'Raison du rebut (facultatif)',
    noReason: 'Aucune raison',
    saveReject: 'Enregistrer',
  ...
  editArchive: {
    ...
    status: 'Statut',
    userVerdict: 'Verdict de résultat',
    verdicts: {
      none: 'Non défini',
      good: 'Bonne pièce',
      reject: 'Rebutée',
  ...
  // Virtual Printer
  paCalibration: {
    title: 'Calibration de la dynamique d\'écoulement',
    menuAction: 'Calibrer la dynamique d\'écoulement…',
    printer: 'Imprimante',
    nozzle: 'Buse',
    slot: 'Emplacement',
    currentK: 'K actuel',
    noProfileYet: 'Aucun profil pour l\'instant',
    cost: 'Durée',
    costValue: 'environ {{minutes}} min, environ {{grams}} g',
    plateType: 'Plateau posé sur le lit',
    plateTypeHint: 'La ligne est tranchée pour ce plateau : il doit correspondre à celui réellement posé.',
    presetsHint: 'Tranché avec ces préréglages. Choisissez le profil de filament correspondant pour une bobine tierce.',
    plateConfirm: 'Le plateau est vide et la ligne imprimée pourra être retirée ensuite.',
    start: 'Lancer la calibration',
    save: 'Enregistrer sur l\'imprimante',
    discard: 'Abandonner',
    cancelPrintConfirm: 'Arrêter l\'impression de calibration ?',
    oldK: 'K enregistré',
    newK: 'K mesuré',
    nCoef: 'Coefficient d\'écoulement',
    confidence: 'Confiance',
    willOverwrite: 'L\'enregistrement remplace le profil K existant.',
    willCreate: 'L\'enregistrement crée un profil K et l\'associe à cet emplacement.',
    notLoaded: 'Chargé dans aucun emplacement',
    noPermission: "Vous n'avez pas l'autorisation de lancer une impression sur cette imprimante.",
    blocked: {
      model_not_supported: 'Pas encore pris en charge sur cette imprimante.',
      printer_offline: 'L\'imprimante est hors ligne.',
      printer_busy: 'L\'imprimante est en cours d\'impression.',
      printer_reserved: 'L\'imprimante est réservée par une autre tâche.',
      run_already_active: 'Une calibration est déjà en cours sur cette imprimante.',
      slicer_not_configured: 'Le service de découpe est injoignable. Cette calibration est une impression tranchée et en dépend.',
      slot_empty: 'Aucun filament identifié dans cet emplacement.',
      nozzle_unknown: 'L\'imprimante n\'a pas indiqué quelle buse est montée.',
      printer_preset_unavailable: 'Le trancheur ne fournit aucun profil pour cette imprimante et cette buse.',
    },
    status: {
      queued: 'En attente de l\'imprimante',
      slicing: 'Découpe en cours',
      uploading: 'Envoi en cours',
      printing: 'Impression',
      reading_result: 'Lecture du résultat',
      awaiting_confirmation: 'En attente de votre décision',
      saving: 'Enregistrement sur l\'imprimante',
      done: 'Enregistré',
      failed: 'Échec',
      cancelled: 'Annulé',
    },
    waiting: {
      printer_offline: 'En attente du retour en ligne de l\'imprimante',
      printer_busy: 'En attente de la fin de la tâche en cours',
      printer_reserved: 'En attente de la libération de l\'imprimante par la file',
      plate_not_cleared: 'En attente de la confirmation que le plateau est vide',
    },
    plates: {
      cool_plate: 'Plateau froid',
      eng_plate: 'Plateau ingénierie',
      hot_plate: 'Plateau PEI lisse',
      textured_plate: 'Plateau PEI texturé',
    },
    preset: {
      printer: 'Préréglage imprimante',
      process: 'Préréglage de processus',
      filament: 'Préréglage filament',
    },
  },
  virtualPrinter: {
  ...
  notifications: {
    ...
    printConfirmRequest: 'Confirmation du résultat',
    printConfirmRequestDescription: 'Demander un verdict bon/rebut avec des liens en un clic à la fin d\'une impression ayant activé l\'option',
    ...
    paCalibration: 'Étalonnage',
    paCalibrationTitle: 'Calibration de la dynamique d\'écoulement',
    paCalibrationDescription: 'Une mesure d\'avance de pression est terminée et attend d\'être enregistrée, ou la série s\'est terminée',
