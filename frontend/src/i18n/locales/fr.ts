export default {
  ...
  printers: {
    ...
    modal: {
      ...
      purchasePrice: 'Prix d\'achat (facultatif)',
      expectedLifetimeHours: 'Durée de vie prévue (heures)',
      depreciationHelp: 'Impute l\'usure de l\'imprimante par heure d\'impression aux impressions futures. Laissez les deux champs vides pour désactiver.',
      depreciationRate: '≈ {{rate}} {{currency}}/h d\'usure de l\'imprimante',
