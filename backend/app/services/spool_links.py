...
# written by propagation. material_number joins the set here because the
# #2870 feature is present on this branch; supplier links (#2988) stay out —
# they are relational rows with their own inheritance, not spool columns.
